...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Vn,depthTest:!1,depthWrite:!1})}function yg(i,e,t){const n=new Float32Array(Si),s=new I(0,1,0);return new Nn({name:"SphericalGaussianBlur",defines:{n:Si,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:ao(),fragmentShader:`
		...
		`,blending:Vn,depthTest:!1,depthWrite:!1})}function th(){return new Nn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ao(),fragmentShader:`
		...
		`,blending:Vn,depthTest:!1,depthWrite:!1})}function nh(){return new Nn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ao(),fragmentShader:`
	...
	`}class zu extends In{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const n={width:e,height:e,depth:1},s=[n,n,n,n,n,n];this.texture=new Du(s),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const n={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},s=new We(5,5,5),r=new Nn({name:"CubemapFromEquirect",uniforms:os(n.uniforms),vertexShader:n.vertexShader,fragmentShader:n.fragmentShader,side:Jt,blending:Vn});r.uniforms.tEquirect.value=t;const o=new ze(s,r),a=t.minFilter;return t.minFilter===ci&&(t.minFilter=Vt),new Tp(1,10,this).update(e,o),t.minFilter=a,o.geometry.dispose(),o.material.dispose(),this}clear(e,t=!0,n=!0,s=!0){const r=e.getRenderTarget();for(let o=0;o<6;o++)e.setRenderTarget(this,o),e.clear(t,n,s);e.setRenderTarget(r)}}function Sg(i){let e=new WeakMap,t=new WeakMap,n=null;function s(h,f=!1){return h==null?null:f?o(h):r(h)}function r(h){if(h&&h.isTexture){const f=h.mapping;if(f===mo||f===go)if(e.has(h)){const m=e.get(h).texture;return a(m,h.mapping)}else{const m=h.image;if(m&&m.height>0){const _=new zu(m.height);return _.fromEquirectangularTexture(i,h),e.set(h,_),h.addEventListener("dispose",c),a(_.texture,h.mapping)}else return null}}return h}function o(h){if(h&&h.isTexture){const f=h.mapping,m=f===mo||f===go,_=f===wi||f===ss;if(m||_){let g=t.get(h);const p=g!==void 0?g.texture.pmremVersion:0;if(h.isRenderTargetTexture&&h.pmremVersion!==p)return n===null&&(n=new jc(i)),g=m?n.fromEquirectangular(h,g):n.fromCubemap(h,g),g.texture.pmremVersion=h.pmremVersion,t.set(h,g),g.texture;if(g!==void 0)return g.texture;{const y=h.image;return m&&y&&y.height>0||_&&y&&l(y)?(n===null&&(n=new jc(i)),g=m?n.fromEquirectangular(h):n.fromCubemap(h),g.texture.pmremVersion=h.pmremVersion,t.set(h,g),h.addEventListener("dispose",u),g.texture):null}}}return h}function a(h,f){return f===mo?h.mapping=wi:f===go&&(h.mapping=ss),h}function l(h){let f=0;const m=6;for(let _=0;_<m;_++)h[_]!==void 0&&f++;return f===m}function c(h){const f=h.target;f.removeEventListener("dispose",c);const m=e.get(f);m!==void 0&&(e.delete(f),m.dispose())}function u(h){const f=h.target;f.removeEventListener("dispose",u);const m=t.get(f);m!==void 0&&(t.delete(f),m.dispose())}function d(){e=new WeakMap,t=new WeakMap,n!==null&&(n.dispose(),n=null)}return{get:s,dispose:d}}function bg(i){const e={};function t(n){if(e[n]!==void 0)return e[n];const s=i.getExtension(n);return e[n]=s,s}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const s=t(n);return s===null&&ji("WebGLRenderer: "+n+" extension not supported."),s}}}function Eg(i,e,t,n){const s={},r=new WeakMap;function o(d){const h=d.target;h.index!==null&&e.remove(h.index);for(const m in h.attributes)e.remove(h.attributes[m]);h.removeEventListener("dispose",o),delete s[h.id];const f=r.get(h);f&&(e.remove(f),r.delete(h)),n.releaseStatesOfGeometry(h),h.isInstancedBufferGeometry===!0&&delete h._maxInstanceCount,t.memory.geometries--}function a(d,h){return s[h.id]===!0||(h.addEventListener("dispose",o),s[h.id]=!0,t.memory.geometries++),h}function l(d){const h=d.attributes;for(const f in h)e.update(h[f],i.ARRAY_BUFFER)}function c(d){const h=[],f=d.index,m=d.attributes.position;let _=0;if(m===void 0)return;if(f!==null){const y=f.array;_=f.version;for(let b=0,M=y.length;b<M;b+=3){const T=y[b+0],w=y[b+1],A=y[b+2];h.push(T,w,w,A,A,T)}}else{const y=m.array;_=m.version;for(let b=0,M=y.length/3-1;b<M;b+=3){const T=b+0,w=b+1,A=b+2;h.push(T,w,w,A,A,T)}}const g=new(m.count>=65535?Pu:Cu)(h,1);g.version=_;const p=r.get(d);p&&e.remove(p),r.set(d,g)}function u(d){const h=r.get(d);if(h){const f=d.index;f!==null&&h.version<f.version&&c(d)}else c(d);return r.get(d)}return{get:a,update:l,getWireframeAttribute:u}}function wg(i,e,t){let n;function s(d){n=d}let r,o;function a(d){r=d.type,o=d.bytesPerElement}function l(d,h){i.drawElements(n,h,r,d*o),t.update(h,n,1)}function c(d,h,f){f!==0&&(i.drawElementsInstanced(n,h,r,d*o,f),t.update(h,n,f))}function u(d,h,f){if(f===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,h,0,r,d,0,f);let _=0;for(let g=0;g<f;g++)_+=h[g];t.update(_,n,1)}this.setMode=s,this.setIndex=a,this.render=l,this.renderInstances=c,this.renderMultiDraw=u}function Tg(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,o,a){switch(t.calls++,o){case i.TRIANGLES:t.triangles+=a*(r/3);break;case i.LINES:t.lines+=a*(r/2);break;case i.LINE_STRIP:t.lines+=a*(r-1);break;case i.LINE_LOOP:t.lines+=a*r;break;case i.POINTS:t.points+=a*r;break;default:Ze("WebGLInfo: Unknown draw mode:",o);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:n}}function Ag(i,e,t){const n=new WeakMap,s=new gt;function r(o,a,l){const c=o.morphTargetInfluences,u=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,d=u!==void 0?u.length:0;let h=n.get(a);if(h===void 0||h.count!==d){let C=function(){x.dispose(),n.delete(a),a.removeEventListener("dispose",C)};var f=C;h!==void 0&&h.texture.dispose();const m=a.morphAttributes.position!==void 0,_=a.morphAttributes.normal!==void 0,g=a.morphAttributes.color!==void 0,p=a.morphAttributes.position||[],y=a.morphAttributes.normal||[],b=a.morphAttributes.color||[];let M=0;m===!0&&(M=1),_===!0&&(M=2),g===!0&&(M=3);let T=a.attributes.position.count*M,w=1;T>e.maxTextureSize&&(w=Math.ceil(T/e.maxTextureSize),T=e.maxTextureSize);const A=new Float32Array(T*w*4*d),x=new Au(A,T,w,d);x.type=_n,x.needsUpdate=!0;const E=M*4;for(let L=0;L<d;L++){const D=p[L],X=y[L],K=b[L],k=T*w*4*L;for(let q=0;q<D.count;q++){const H=q*E;m===!0&&(s.fromBufferAttribute(D,q),A[k+H+0]=s.x,A[k+H+1]=s.y,A[k+H+2]=s.z,A[k+H+3]=0),_===!0&&(s.fromBufferAttribute(X,q),A[k+H+4]=s.x,A[k+H+5]=s.y,A[k+H+6]=s.z,A[k+H+7]=0),g===!0&&(s.fromBufferAttribute(K,q),A[k+H+8]=s.x,A[k+H+9]=s.y,A[k+H+10]=s.z,A[k+H+11]=K.itemSize===4?s.w:1)}}h={count:d,texture:x,size:new He(T,w)},n.set(a,h),a.addEventListener("dispose",C)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",o.morphTexture,t);else{let m=0;for(let g=0;g<c.length;g++)m+=c[g];const _=a.morphTargetsRelative?1:1-m;l.getUniforms().setValue(i,"morphTargetBaseInfluence",_),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",h.texture,t),l.getUniforms().setValue(i,"morphTargetsTextureSize",h.size)}return{update:r}}function Rg(i,e,t,n,s){let r=new WeakMap;function o(c){const u=s.render.frame,d=c.geometry,h=e.get(c,d);if(r.get(h)!==u&&(e.update(h),r.set(h,u)),c.isInstancedMesh&&(c.hasEventListener("dispose",l)===!1&&c.addEventListener("dispose",l),r.get(c)!==u&&(t.update(c.instanceMatrix,i.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,i.ARRAY_BUFFER),r.set(c,u))),c.isSkinnedMesh){const f=c.skeleton;r.get(f)!==u&&(f.update(),r.set(f,u))}return h}function a(){r=new WeakMap}function l(c){const u=c.target;u.removeEventListener("dispose",l),n.releaseStatesOfObject(u),t.remove(u.instanceMatrix),u.instanceColor!==null&&t.remove(u.instanceColor)}return{update:o,dispose:a}}const Cg={[du]:"LINEAR_TONE_MAPPING",[fu]:"REINHARD_TONE_MAPPING",[pu]:"CINEON_TONE_MAPPING",[mu]:"ACES_FILMIC_TONE_MAPPING",[xu]:"AGX_TONE_MAPPING",[_u]:"NEUTRAL_TONE_MAPPING",[gu]:"CUSTOM_TONE_MAPPING"};function Pg(i,e,t,n,s,r){const o=new In(e,t,{type:i,depthBuffer:s,stencilBuffer:r,samples:n?4:0,depthTexture:s?new rs(e,t):void 0}),a=new In(e,t,{type:$n,depthBuffer:!1,stencilBuffer:!1}),l=new Rt;l.setAttribute("position",new Xe([-1,3,0,-1,-1,0,3,-1,0],3)),l.setAttribute("uv",new Xe([0,2,0,0,2,0],2));const c=new vp({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),u=new ze(l,c),d=new oo(-1,1,1,-1,0,1);let h=null,f=null,m=!1,_,g=null,p=[],y=!1;this.setSize=function(b,M){o.setSize(b,M),a.setSize(b,M);for(let T=0;T<p.length;T++){const w=p[T];w.setSize&&w.setSize(b,M)}},this.setEffects=function(b){p=b,y=p.length>0&&p[0].isRenderPass===!0;const M=o.width,T=o.height;for(let w=0;w<p.length;w++){const A=p[w];A.setSize&&A.setSize(M,T)}},this.begin=function(b,M){if(m||b.toneMapping===Ln&&p.length===0)return!1;if(g=M,M!==null){const T=M.width,w=M.height;(o.width!==T||o.height!==w)&&this.setSize(T,w)}return y===!1&&b.setRenderTarget(o),_=b.toneMapping,b.toneMapping=Ln,!0},this.hasRenderPass=function(){return y},this.end=function(b,M){b.toneMapping=_,m=!0;let T=o,w=a;for(let A=0;A<p.length;A++){const x=p[A];if(x.enabled!==!1&&(x.render(b,w,T,M),x.needsSwap!==!1)){const E=T;T=w,w=E}}if(h!==b.outputColorSpace||f!==b.toneMapping){h=b.outputColorSpace,f=b.toneMapping,c.defines={},qe.getTransfer(h)===ot&&(c.defines.SRGB_TRANSFER="");const A=Cg[f];A&&(c.defines[A]=""),c.needsUpdate=!0}c.uniforms.tDiffuse.value=T.texture,b.setRenderTarget(g),b.render(u,d),g=null,m=!1},this.isCompositing=function(){return m},this.dispose=function(){o.depthTexture&&o.depthTexture.dispose(),o.dispose(),a.dispose(),l.dispose(),c.dispose()}}const Gu=new Xt,Za=new rs(1,1),Hu=new Au,Vu=new $f,Wu=new Du,ih=[],sh=[],rh=new Float32Array(16),oh=new Float32Array(9),ah=new Float32Array(4);function ds(i,e,t){const n=i[0];if(n<=0||n>0)return i;const s=e*t;let r=ih[s];if(r===void 0&&(r=new Float32Array(s),ih[s]=r),e!==0){n.toArray(r,0);for(let o=1,a=0;o!==e;++o)a+=t,i[o].toArray(r,a)}return r}function Pt(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function Lt(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function lo(i,e){let t=sh[e];t===void 0&&(t=new Int32Array(e),sh[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function Lg(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function Ig(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Pt(t,e))return;i.uniform2fv(this.addr,e),Lt(t,e)}}function Dg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(Pt(t,e))return;i.uniform3fv(this.addr,e),Lt(t,e)}}function Ng(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Pt(t,e))return;i.uniform4fv(this.addr,e),Lt(t,e)}}function Ug(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(Pt(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),Lt(t,e)}else{if(Pt(t,n))return;ah.set(n),i.uniformMatrix2fv(this.addr,!1,ah),Lt(t,n)}}function Fg(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(Pt(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),Lt(t,e)}else{if(Pt(t,n))return;oh.set(n),i.uniformMatrix3fv(this.addr,!1,oh),Lt(t,n)}}function Og(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(Pt(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),Lt(t,e)}else{if(Pt(t,n))return;rh.set(n),i.uniformMatrix4fv(this.addr,!1,rh),Lt(t,n)}}function kg(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function Bg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Pt(t,e))return;i.uniform2iv(this.addr,e),Lt(t,e)}}function zg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Pt(t,e))return;i.uniform3iv(this.addr,e),Lt(t,e)}}function Gg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Pt(t,e))return;i.uniform4iv(this.addr,e),Lt(t,e)}}function Hg(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function Vg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Pt(t,e))return;i.uniform2uiv(this.addr,e),Lt(t,e)}}function Wg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Pt(t,e))return;i.uniform3uiv(this.addr,e),Lt(t,e)}}function Xg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Pt(t,e))return;i.uniform4uiv(this.addr,e),Lt(t,e)}}function $g(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(Za.compareFunction=t.isReversedDepthBuffer()?yl:Ml,r=Za):r=Gu,t.setTexture2D(e||r,s)}function qg(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture3D(e||Vu,s)}function Yg(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTextureCube(e||Wu,s)}function Kg(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture2DArray(e||Hu,s)}function Zg(i){switch(i){case 5126:return Lg;case 35664:return Ig;case 35665:return Dg;case 35666:return Ng;case 35674:return Ug;case 35675:return Fg;case 35676:return Og;case 5124:case 35670:return kg;case 35667:case 35671:return Bg;case 35668:case 35672:return zg;case 35669:case 35673:return Gg;case 5125:return Hg;case 36294:return Vg;case 36295:return Wg;case 36296:return Xg;case 35678:case 36198:case 36298:case 36306:case 35682:return $g;case 35679:case 36299:case 36307:return qg;case 35680:case 36300:case 36308:case 36293:return Yg;case 36289:case 36303:case 36311:case 36292:return Kg}}function Jg(i,e){i.uniform1fv(this.addr,e)}function Qg(i,e){const t=ds(e,this.size,2);i.uniform2fv(this.addr,t)}function jg(i,e){const t=ds(e,this.size,3);i.uniform3fv(this.addr,t)}function ex(i,e){const t=ds(e,this.size,4);i.uniform4fv(this.addr,t)}function tx(i,e){const t=ds(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function nx(i,e){const t=ds(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function ix(i,e){const t=ds(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function sx(i,e){i.uniform1iv(this.addr,e)}function rx(i,e){i.uniform2iv(this.addr,e)}function ox(i,e){i.uniform3iv(this.addr,e)}function ax(i,e){i.uniform4iv(this.addr,e)}function lx(i,e){i.uniform1uiv(this.addr,e)}function cx(i,e){i.uniform2uiv(this.addr,e)}function hx(i,e){i.uniform3uiv(this.addr,e)}function ux(i,e){i.uniform4uiv(this.addr,e)}function dx(i,e,t){const n=this.cache,s=e.length,r=lo(t,s);Pt(n,r)||(i.uniform1iv(this.addr,r),Lt(n,r));let o;this.type===i.SAMPLER_2D_SHADOW?o=Za:o=Gu;for(let a=0;a!==s;++a)t.setTexture2D(e[a]||o,r[a])}function fx(i,e,t){const n=this.cache,s=e.length,r=lo(t,s);Pt(n,r)||(i.uniform1iv(this.addr,r),Lt(n,r));for(let o=0;o!==s;++o)t.setTexture3D(e[o]||Vu,r[o])}function px(i,e,t){const n=this.cache,s=e.length,r=lo(t,s);Pt(n,r)||(i.uniform1iv(this.addr,r),Lt(n,r));for(let o=0;o!==s;++o)t.setTextureCube(e[o]||Wu,r[o])}function mx(i,e,t){const n=this.cache,s=e.length,r=lo(t,s);Pt(n,r)||(i.uniform1iv(this.addr,r),Lt(n,r));for(let o=0;o!==s;++o)t.setTexture2DArray(e[o]||Hu,r[o])}function gx(i){switch(i){case 5126:return Jg;case 35664:return Qg;case 35665:return jg;case 35666:return ex;case 35674:return tx;case 35675:return nx;case 35676:return ix;case 5124:case 35670:return sx;case 35667:case 35671:return rx;case 35668:case 35672:return ox;case 35669:case 35673:return ax;case 5125:return lx;case 36294:return cx;case 36295:return hx;case 36296:return ux;case 35678:case 36198:case 36298:case 36306:case 35682:return dx;case 35679:case 36299:case 36307:return fx;case 35680:case 36300:case 36308:case 36293:return px;case 36289:case 36303:case 36311:case 36292:return mx}}class xx{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=Zg(t.type)}}class _x{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=gx(t.type)}}class vx{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const s=this.seq;for(let r=0,o=s.length;r!==o;++r){const a=s[r];a.setValue(e,t[a.id],n)}}}const Yo=/(\w+)(\])?(\[|\.)?/g;function lh(i,e){i.seq.push(e),i.map[e.id]=e}function Mx(i,e,t){const n=i.name,s=n.length;for(Yo.lastIndex=0;;){const r=Yo.exec(n),o=Yo.lastIndex;let a=r[1];const l=r[2]==="]",c=r[3];if(l&&(a=a|0),c===void 0||c==="["&&o+2===s){lh(t,c===void 0?new xx(a,i,e):new _x(a,i,e));break}else{let d=t.map[a];d===void 0&&(d=new vx(a),lh(t,d)),t=d}}}class Br{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let o=0;o<n;++o){const a=e.getActiveUniform(t,o),l=e.getUniformLocation(t,a.name);Mx(a,l,this)}const s=[],r=[];for(const o of this.seq)o.type===e.SAMPLER_2D_SHADOW||o.type===e.SAMPLER_CUBE_SHADOW||o.type===e.SAMPLER_2D_ARRAY_SHADOW?s.push(o):r.push(o);s.length>0&&(this.seq=s.concat(r))}setValue(e,t,n,s){const r=this.map[t];r!==void 0&&r.setValue(e,n,s)}setOptional(e,t,n){const s=t[n];s!==void 0&&this.setValue(e,n,s)}static upload(e,t,n,s){for(let r=0,o=t.length;r!==o;++r){const a=t[r],l=n[a.id];l.needsUpdate!==!1&&a.setValue(e,l.value,s)}}static seqWithValue(e,t){const n=[];for(let s=0,r=e.length;s!==r;++s){const o=e[s];o.id in t&&n.push(o)}return n}}function ch(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const yx=37297;let Sx=0;function bx(i,e){const t=i.split(`
`),n=[],s=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let o=s;o<r;o++){const a=o+1;n.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return n.join(`
`)}const hh=new Fe;function Ex(i){qe._getMatrix(hh,qe.workingColorSpace,i);const e=`mat3( ${hh.elements.map(t=>t.toFixed(4))} )`;switch(qe.getTransfer(i)){case Xr:return[e,"LinearTransferOETF"];case ot:return[e,"sRGBTransferOETF"];default:return De("WebGLProgram: Unsupported color space: ",i),[e,"LinearTransferOETF"]}}function uh(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),r=(i.getShaderInfoLog(e)||"").trim();if(n&&r==="")return"";const o=/ERROR: 0:(\d+)/.exec(r);if(o){const a=parseInt(o[1]);return t.toUpperCase()+`

`+r+`

`+bx(i.getShaderSource(e),a)}else return r}function wx(i,e){const t=Ex(e);return[`vec4 ${i}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}const Tx={[du]:"Linear",[fu]:"Reinhard",[pu]:"Cineon",[mu]:"ACESFilmic",[xu]:"AgX",[_u]:"Neutral",[gu]:"Custom"};function Ax(i,e){const t=Tx[e];return t===void 0?(De("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const wr=new I;function Rx(){qe.getLuminanceCoefficients(wr);const i=wr.x.toFixed(4),e=wr.y.toFixed(4),t=wr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function Cx(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(ws).join(`
`)}function Px(i){const e=[];for(const t in i){const n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function Lx(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(e,s),o=r.name;let a=1;r.type===i.FLOAT_MAT2&&(a=2),r.type===i.FLOAT_MAT3&&(a=3),r.type===i.FLOAT_MAT4&&(a=4),t[o]={type:r.type,location:i.getAttribLocation(e,o),locationSize:a}}return t}function ws(i){return i!==""}function dh(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function fh(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const Ix=/^[ \t]*#include +<([\w\d./]+)>/gm;function Ja(i){return i.replace(Ix,Nx)}const Dx=new Map;function Nx(i,e){let t=Ge[e];if(t===void 0){const n=Dx.get(e);if(n!==void 0)t=Ge[n],De('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("THREE.WebGLProgram: Can not resolve #include <"+e+">")}return Ja(t)}const Ux=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function ph(i){return i.replace(Ux,Fx)}function Fx(i,e,t,n){let s="";for(let r=parseInt(e);r<parseInt(t);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function mh(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}const Ox={[Dr]:"SHADOWMAP_TYPE_PCF",[Es]:"SHADOWMAP_TYPE_VSM"};function kx(i){return Ox[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const Bx={[wi]:"ENVMAP_TYPE_CUBE",[ss]:"ENVMAP_TYPE_CUBE",[so]:"ENVMAP_TYPE_CUBE_UV"};function zx(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":Bx[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const Gx={[ss]:"ENVMAP_MODE_REFRACTION"};function Hx(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":Gx[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const Vx={[dl]:"ENVMAP_BLENDING_MULTIPLY",[wf]:"ENVMAP_BLENDING_MIX",[Tf]:"ENVMAP_BLENDING_ADD"};function Wx(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":Vx[i.combine]||"ENVMAP_BLENDING_NONE"}function Xx(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function $x(i,e,t,n){const s=i.getContext(),r=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=kx(t),c=zx(t),u=Hx(t),d=Wx(t),h=Xx(t),f=Cx(t),m=Px(r),_=s.createProgram();let g,p,y=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+p);const b=y+g+o,M=y+p+a,T=ch(s,s.VERTEX_SHADER,b),w=ch(s,s.FRAGMENT_SHADER,M);s.attachShader(_,T),s.attachShader(_,w),t.index0AttributeName!==void 0?s.bindAttribLocation(_,0,t.index0AttributeName):t.hasPositionAttribute===!0&&s.bindAttribLocation(_,0,"position"),s.linkProgram(_);function A(L){if(i.debug.checkShaderErrors){const D=s.getProgramInfoLog(_)||"",X=s.getShaderInfoLog(T)||"",K=s.getShaderInfoLog(w)||"",k=D.trim(),q=X.trim(),H=K.trim();let j=!0,te=!0;if(s.getProgramParameter(_,s.LINK_STATUS)===!1)if(j=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,_,T,w);else{const re=uh(s,T,"vertex"),ue=uh(s,w,"fragment");Ze("WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(_,s.VALIDATE_STATUS)+`
...
void main() {
    ...
    `;const r=[...e.inventory.entries()].filter(([,o])=>o>0);this.pack.innerHTML=r.length?r.map(([o,a])=>`<div class="slot ${e.equipped===o?"equipped":""}"><span class="n">${a}</span>${pt[o].name}</div>`).join(""):'<div class="slot">empty pack</div>',this.renderHotbar(e),this.renderBuilder(t.selection,t.buildableFixtures),this.logEl.innerHTML=this.messages.map(o=>`<div class="${o.age<2.5?"fresh":""}">${o.text}</div>`).join("")}renderHotbar(e){this.hotbar.innerHTML=Ku.map((t,n)=>{const s=t.options.find(a=>(e.inventory.get(a)??0)>0),r=s?e.equipped===s?"equipped":"":"empty",o=s?pt[s].name:t.label;return`<div class="hslot ${r}" data-item="${s??""}"><span class="n">${n+1}</span>${o}</div>`}).join("");for(const t of this.hotbar.querySelectorAll(".hslot"))t.onclick=()=>{var s;const n=t.dataset.item;n&&((s=this.onSelectTool)==null||s.call(this,n))}}renderBuilder(e,t={}){const n=["<h3>Fixtures</h3>"];ja.forEach((s,r)=>{const o=yn[s],a=t[s]??!1,l=(e==null?void 0:e.mode)==="fixture"&&e.kind===s;n.push(`
        ...
        </div>`)}),this.builder.innerHTML=n.join("");for(const s of this.builder.querySelectorAll(".row"))s.onclick=()=>{var a;if(s.classList.contains("locked"))return;const r=s.dataset.mode,o=s.dataset.kind;(a=this.onSelect)==null||a.call(this,r==="piece"?{mode:"piece",kind:o}:{mode:"fixture",kind:o})}}}const Il="settlement.cursor",cv=40,hv="button, .mm-btn, .row, .hslot, .cr-row, .cr-btn, [data-act], select, label, a";function uv(){let i=document.getElementById("cursorStyle");return i||(i=document.createElement("style"),i.id="cursorStyle",document.head.appendChild(i)),i}function Rh(i,e){uv().textContent=`
    *, html, body, #game, .panel, input {
      cursor: url(${i.url}) ${i.hotX} ${i.hotY}, auto !important;
    }
    ${hv} {
      cursor: url(${e.url}) ${e.hotX} ${e.hotY}, auto !important;
    }`}function Dl(i){const e=document.createElement("canvas");return e.width=i,e.height=i,[e,e.getContext("2d")]}function Zu(i,e,t,n,s){const r=i.createLinearGradient(e,t,n,s);return r.addColorStop(0,"#f6de88"),r.addColorStop(.5,"#e6c463"),r.addColorStop(1,"#b0842d"),r}function Rr(i,e,t,n,s,r){i.beginPath(),i.moveTo(e+r,t),i.arcTo(e+n,t,e+n,t+s,r),i.arcTo(e+n,t+s,e,t+s,r),i.arcTo(e,t+s,e,t,r),i.arcTo(e,t,e+n,t,r),i.closePath()}let Cr=null;function dv(){if(Cr)return Cr;const[i,e]=Dl(28),t=[[2,2],[2,21],[7,16.5],[10.5,23.5],[13.7,22],[10.2,15.5],[18,15.5]];e.beginPath(),e.moveTo(t[0][0],t[0][1]);for(const[n,s]of t.slice(1))e.lineTo(n,s);return e.closePath(),e.fillStyle=Zu(e,2,2,17,22),e.fill(),e.lineJoin="round",e.lineWidth=1.6,e.strokeStyle="#241606",e.stroke(),e.beginPath(),e.moveTo(3.4,4),e.lineTo(3.4,16),e.lineWidth=1.1,e.strokeStyle="rgba(255, 247, 218, 0.85)",e.stroke(),Cr={url:i.toDataURL("image/png"),hotX:2,hotY:2},Cr}let Pr=null;function fv(){if(Pr)return Pr;const[i,e]=Dl(28);e.lineJoin="round",e.lineCap="round";const t=()=>{e.lineWidth=1.5,e.strokeStyle="#241606",e.stroke()},n=(s,r,o,a)=>{e.fillStyle=Zu(e,s,r,o,a),e.fill()};Rr(e,5,12.5,16.5,12,5),n(5,12.5,20,24.5),t();for(const s of[11.4,14.7,18])Rr(e,s,10.6,3.2,4.4,1.5),n(s,10.6,s+3.2,15),t();return Rr(e,6.4,2.5,4.3,12,2.1),n(6.4,2.5,10.7,14),t(),e.save(),e.translate(5.4,16),e.rotate(-.55),Rr(e,-3.4,-2,4,6.6,2),n(-3.4,-2,.6,4.6),t(),e.restore(),e.beginPath(),e.moveTo(7.7,4),e.lineTo(7.7,12.5),e.lineWidth=1,e.strokeStyle="rgba(255, 247, 218, 0.8)",e.stroke(),Pr={url:i.toDataURL("image/png"),hotX:8,hotY:2},Pr}function Ju(){try{return localStorage.getItem(Il)}catch{return null}}function Nl(){const i=Ju();if(i){const e={url:i,hotX:0,hotY:0};Rh(e,e)}else Rh(dv(),fv())}const pv=()=>Ju()!==null;function mv(){Nl()}function gv(){try{localStorage.removeItem(Il)}catch{}Nl()}function xv(i,e){const t=new FileReader;t.onerror=()=>e==null?void 0:e(!1),t.onload=()=>{const n=new Image;n.onerror=()=>e==null?void 0:e(!1),n.onload=()=>{const s=Math.min(1,cv/Math.max(n.width,n.height)),r=Math.max(1,Math.round(n.width*s)),o=Math.max(1,Math.round(n.height*s)),[a,l]=Dl(1);a.width=r,a.height=o,l.imageSmoothingEnabled=!1,l.drawImage(n,0,0,r,o);try{localStorage.setItem(Il,a.toDataURL("image/png"))}catch{}Nl(),e==null||e(!0)},n.src=t.result},t.readAsDataURL(i)}const Ch={a:"ᚪ",b:"ᛒ",c:"ᚳ",d:"ᛞ",e:"ᛖ",f:"ᚠ",g:"ᚷ",h:"ᚻ",i:"ᛁ",j:"ᛄ",k:"ᚳ",l:"ᛚ",m:"ᛗ",n:"ᚾ",o:"ᚩ",p:"ᛈ",q:"ᚳ",r:"ᚱ",s:"ᛋ",t:"ᛏ",u:"ᚢ",v:"ᚠ",w:"ᚹ",x:"ᛉ",y:"ᚣ",z:"ᛋ"};function Qu(i){const e=i.toLowerCase();let t="",n=0,s="";for(;n<e.length;){const r=e.slice(n,n+3),o=e.slice(n,n+2);if(r==="sch")t+="ᛋᚳ",n+=3,s="";else if(o==="sh")t+="ᛋᚳ",n+=2,s="";else if(o==="th")t+="ᚦ",n+=2,s="";else if(o==="ng")t+="ᛝ",n+=2,s="";else if(o==="ea")t+="ᛠ",n+=2,s="";else{const a=e[n];n++,a===" "?(t+="᛫",s=" "):a===s||(Ch[a]?(t+=Ch[a],s=a):s="")}}return t}function Qo(i,e,t=!0){const n=t?`<span class="mm-cred-runes" aria-hidden="true">${Qu(e)}</span>`:"";return`<div class="mm-credit">
      ...
      <span class="mm-btn-runes" aria-hidden="true">${Qu(e)}</span>
      ...
      <div class="mm-rows">
        <div class="mm-row">
          ...
          <span class="mm-inline">
            ...
            ${zn("cursor-reset","Reset",{small:!0,disabled:!pv()})}
          </span>
        </div>
        <div class="mm-row">
    ...
    <div class="mm-panel">
      ...
      <div class="mm-credits">
        ${Qo("Design &amp; code","Lucas Schappi")}
        ${Qo("Built with","Claude Code")}
        ${Qo("Engine","TypeScript · Three.js · Vite",!1)}
      </div>
      <div class="mm-buttons">
        ${zn("back","Back")}
      </div>
    </div>`;function a(l){e.innerHTML=l();for(const u of e.querySelectorAll(".mm-btn"))u.addEventListener("click",()=>{var d;switch(u.dataset.act){case"begin":i.onBegin();break;case"continue":i.onContinue();break;case"settings":a(r);break;case"credits":a(o);break;case"delete":i.onDeleteSave(),n=!1,a(r);break;case"cursor-upload":(d=e.querySelector("#mmCursorFile"))==null||d.click();break;case"cursor-reset":gv(),a(r);break;case"back":a(s);break}});const c=e.querySelector("#mmCursorFile");c&&c.addEventListener("change",()=>{var d;const u=(d=c.files)==null?void 0:d[0];u&&xv(u,()=>a(r))})}a(s)}const vv=1.6;function co(i,e,t,n){const s=Wd[e.kind];let r;s.tool==="chop"?(Zr(i,"chop"),r=J_(i)):s.tool==="mine"?(Zr(i,"mine"),r=Q_(i)):r=1;const o=s.tool==="hand"?.6:3.2;if(i.stamina<=0)return{gained:0,depleted:!1};i.stamina=Math.max(0,i.stamina-o*n);const a=vv*r*n,l=t.harvest(e,a);if(l<=0)return{gained:0,depleted:e.amount<=0};const u=(e._frac??0)+l*s.per,d=Math.floor(u);return e._frac=u-d,d>0&&Ll(i,s.item,d),{gained:d,depleted:e.amount<=0,item:s.item}}const Ul=i=>i===Ye.OakTree||i===Ye.BirchTree||i===Ye.PineTree;function Fl(i,e,t,n){const s=e+Math.cos(n)*.6,r=t+Math.sin(n)*.6,o=i.elevationAt(s,r);i.pieces.add(xn("log",s,r,o,n,!1,!0))}const Mv=i=>i===Ye.Boulder;function ju(i,e){i.removeResource(e);const t=i.elevationAt(e.x,e.y);i.pieces.add(xn("stoneBlock",e.x,e.y,t,0,!1,!0))}function yv(i,e,t){const n=yn[e.kind];for(const r of n.cost){const o=e.delivered.find(c=>c.item===r.item),a=(o==null?void 0:o.count)??0;if(a>=r.count)continue;const l=Fs(i,r.item,r.count-a);l>0&&(o?o.count+=l:e.delivered.push({item:r.item,count:l}))}return n.cost.every(r=>{var o;return(((o=e.delivered.find(a=>a.item===r.item))==null?void 0:o.count)??0)>=r.count})?(i.stamina=Math.max(0,i.stamina-2*t),e.progress=Math.min(1,e.progress+t/n.work),e.progress>=1?(e.hp=e.maxHp,!0):!1):!1}const Sv=3.5,jo=4,Ph=1.4,bv=["log","beam","post","splitLog","plank","stoneBlock","stoneSlab","boulder","thatchBundle"];function Ev(i,e,t,n){const s=Je[n],r=Math.max(0,bv.indexOf(n)),o=t.x+(r-1)*Ph,a=t.y,l=e.queryRadius(o,a,Ph*.6).filter(_=>_.kind===n).length,c=Math.floor(l/jo),u=l%jo,d=Math.max(s.width,s.thickness)+.02,h=a+(u-(jo-1)/2)*d,m=i.elevationAt(o,h)+c*s.thickness;return{x:o,y:h,z:m,yaw:0,upright:!1}}function ed(i,e){return i.queryRadius(e.x,e.y,.2).some(t=>t.upright&&Math.hypot(t.x-e.x,t.y-e.y)<.15)}function wv(i,e,t){let n=null,s=1/0;for(const r of e){if(ed(i,r))continue;const o=(r.x-t.x)**2+(r.y-t.y)**2;o<s&&(s=o,n=r)}return n}function Ol(i,e,t,n){return i.queryRadius(t.x,t.y,n).filter(r=>r.loose===!0).filter(r=>Math.hypot(r.x-e.x,r.y-e.y)>Sv).sort((r,o)=>(r.x-t.x)**2+(r.y-t.y)**2-((o.x-t.x)**2+(o.y-t.y)**2))}const Ts=.5,Tv=4e3,Av=.45,ea=(i,e)=>(i&65535)*65536+(e&65535),oi=i=>(i+.5)*Ts;function Rv(i,e,t,n,s){const r=Math.floor(e/Ts),o=Math.floor(t/Ts),a=Math.floor(n/Ts),l=Math.floor(s/Ts);if(r===a&&o===l)return[{x:n,y:s}];const c=new Map,u=(p,y)=>{if(p===a&&y===l||p===r&&y===o)return i.canStand(oi(p),oi(y));const b=ea(p,y);let M=c.get(b);return M===void 0&&(M=i.canStand(oi(p),oi(y),Av),c.set(b,M)),M},d=(p,y)=>{const b=Math.abs(p-a),M=Math.abs(y-l);return b+M+(Math.SQRT2-2)*Math.min(b,M)},h=[],f=new Map,m={cx:r,cy:o,g:0,f:d(r,o),parent:null};h.push(m),f.set(ea(r,o),0);let _=0,g=m;for(;h.length>0&&_<Tv;){let p=0;for(let b=1;b<h.length;b++)h[b].f<h[p].f&&(p=b);const y=h.splice(p,1)[0];if(_++,y.cx===a&&y.cy===l)return Lh(y,n,s);d(y.cx,y.cy)<d(g.cx,g.cy)&&(g=y);for(let b=-1;b<=1;b++)for(let M=-1;M<=1;M++){if(M===0&&b===0)continue;const T=y.cx+M,w=y.cy+b;if(!u(T,w)||M!==0&&b!==0&&(!u(y.cx+M,y.cy)||!u(y.cx,y.cy+b)))continue;const A=M!==0&&b!==0?Math.SQRT2:1,x=y.g+A,E=ea(T,w);x>=(f.get(E)??1/0)||(f.set(E,x),h.push({cx:T,cy:w,g:x,f:x+d(T,w),parent:y}))}}return g!==m?Lh(g,oi(g.cx),oi(g.cy)):null}function Lh(i,e,t){const n=[];for(let r=i;r;r=r.parent)n.push(r);n.reverse();const s=n.map(r=>({x:oi(r.cx),y:oi(r.cy)}));return s[s.length-1]={x:e,y:t},Cv(s)}function Cv(i){if(i.length<=2)return i;const e=[i[0]];for(let t=1;t<i.length-1;t++){const n=e[e.length-1],s=i[t],r=i[t+1],o=(s.x-n.x)*(r.y-n.y)-(s.y-n.y)*(r.x-n.x);Math.abs(o)>1e-6&&e.push(s)}return e.push(i[i.length-1]),e}const Ih=Math.PI/2,Dh=.125,Ps=.25,as=i=>Math.floor(i/Ps)*Ps+Ps/2,Nh=8,Uh=3,Pv=1,Fh=5,Lv=.45,Iv=.1,ks=.01;function el(i,e,t,n,s,r){return{id:-1,kind:i,x:e,y:t,z:n,yaw:s,upright:r,load:0,integrity:1}}function td(i,e,t,n,s,r){return Mn(el(i,e,t,n,s,r))}function ls(i,e,t,n,s,r,o,a=-1/0){const l=i.elevationAt(n,s);if(Ji(i.biomeAt(Math.floor(n),Math.floor(s))))return{ok:!1,z:l,support:0,supporters:[],reason:"In the water"};const c=td(t,n,s,-50,r,o),u=e.query({...c,z0:-50,z1:50}),d=el(t,n,s,-50,r,o);let h=l;for(const b of u){if(ll(d,b)<=.02)continue;const M=Wt(b).z1;M>h&&M>=a-ks&&(h=M)}const f=Math.max(h,a===-1/0?h:a),m=el(t,n,s,f,r,o);for(const b of u)if(zd(m,b))return{ok:!1,z:f,support:0,supporters:[],reason:"Blocked by another piece"};const _=Dv(m,f,l,u),{support:g,supporters:p}=_;if(!_.stable)return{ok:!1,z:f,support:g,supporters:p,reason:_.reason};const y=Je[t];for(const b of p){const M=Je[b.kind],T=y.mass/Math.max(1,p.length);if(b.load+T>M.bearing)return{ok:!1,z:f,support:g,supporters:p,reason:`The ${M.name.toLowerCase()} below would give way`}}return{ok:!0,z:f,support:g,supporters:p}}function Dv(i,e,t,n){const s=Wt(i),r=Bd(s);if(Math.abs(e-t)<=ks)return{stable:!0,support:1,supporters:[]};const o=[],a=[];let l=0;for(const u of n){const d=Wt(u).z1;if(d>e+ks||d<e-Iv)continue;const h=kd(s,Wt(u));if(h.length===0)continue;const f=hu(h);f<=0||(l+=f,a.push(...h),o.push(u))}return{stable:!0,support:r>0?Math.min(1,l/r):0,supporters:o}}function cs(i,e,t,n,s,r,o){const a=xn(e,t,n,o.z,s,r);return i.add(a),nd(i,[a,...o.supporters]),a}function nd(i,e){const t=new Set,n=[...e],s=4e3;for(;n.length&&t.size<s;){const o=n.shift();t.has(o)||(t.add(o),n.push(...Jr(i,o),...id(i,o)))}for(const o of t)o.load=0;const r=[...t].sort((o,a)=>a.z-o.z);for(const o of r){const a=Jr(i,o);if(a.length===0)continue;const l=(Je[o.kind].mass+o.load)/a.length;for(const c of a)c.load+=l}}function Jr(i,e){const t=Mn(e);return i.query({...t,z0:t.z0-.1,z1:t.z0+.1}).filter(n=>n.id!==e.id&&Math.abs(Wt(n).z1-Wt(e).z0)<=ks).filter(n=>ll(e,n)>0)}function id(i,e){const t=Mn(e);return i.query({...t,z0:t.z1-.1,z1:t.z1+.1}).filter(n=>n.id!==e.id&&Math.abs(Wt(n).z0-Wt(e).z1)<=ks).filter(n=>ll(e,n)>0)}function Nv(i,e,t){const n=[],s=Jr(e,t);e.remove(t);const r=[...s,...n.flatMap(o=>Jr(e,o))].filter(o=>e.get(o.id)!==void 0);return r.length&&nd(e,r),{removed:[t],collapsed:n}}function Uv(i){const e=Je[i.kind],t=Math.cos(i.yaw),n=Math.sin(i.yaw),s=[];if(i.upright){const u=e.length,d=Math.max(e.width,e.thickness)/2,h=[{x:t,y:n},{x:-t,y:-n},{x:-n,y:t},{x:n,y:-t}];for(const f of h){for(let m=0;m<Nh;m++){const _=(m+1)/(Nh+1)*u;s.push({x:i.x+f.x*d,y:i.y+f.y*d,z:i.z+_,nx:f.x,ny:f.y,kind:"side",host:i})}s.push({x:i.x+f.x*d,y:i.y+f.y*d,z:i.z,nx:f.x,ny:f.y,kind:"bottom",host:i})}return s.push({x:i.x,y:i.y,z:i.z+u,nx:0,ny:0,kind:"top",host:i}),s}const r=Wt(i),o=t,a=n,l=-n,c=t;for(const u of[-1,1])for(let d=0;d<Uh;d++){const h=-r.hx+d*(2*r.hx)/(Uh-1);s.push({x:r.cx+o*h+l*u*r.hy,y:r.cy+a*h+c*u*r.hy,z:r.z0,nx:l*u,ny:c*u,kind:"side",host:i})}for(const u of[-1,1])for(let d=0;d<Pv;d++)s.push({x:r.cx+o*u*r.hx+l*0,y:r.cy+a*u*r.hx+c*0,z:r.z0,nx:o*u,ny:a*u,kind:"end",host:i});for(let u=0;u<Fh;u++){const d=-r.hx+u*(2*r.hx)/(Fh-1);s.push({x:r.cx+o*d,y:r.cy+a*d,z:r.z1,nx:0,ny:0,kind:"top",host:i})}return s}function sd(i,e){return!(e&&i.host.upright&&i.kind==="side")}function Fv(i,e,t){if(i.kind!=="top")return!0;const n=Wt(i.host),s=Math.cos(n.yaw),r=Math.sin(n.yaw),o=e-n.cx,a=t-n.cy,l=Math.abs(o*s+a*r),c=Math.abs(-o*r+a*s),u=.1;return l<=n.hx+u&&c<=n.hy+u}function rd(i,e,t,n=3){const s=[];for(const r of i.queryRadius(e,t,n))s.push(...Uv(r));return s}function od(i,e,t,n,s=0){if(i.kind==="top")return{x:i.x,y:i.y,z:i.z,yaw:t};const r=Je[e],o=(n?r.width:r.length)/2,a=(n?r.thickness:r.width)/2,l=Math.atan2(i.ny,i.nx);return s%2===0?{x:i.x+i.nx*o,y:i.y+i.ny*o,z:i.z,yaw:l}:{x:i.x+i.nx*a,y:i.y+i.ny*a,z:i.z,yaw:l+Math.PI/2}}function Ov(i,e,t,n,s,r){const o=rd(i,t,n,3).filter(u=>sd(u,r)).filter(u=>Fv(u,t,n));if(o.length===0)return null;let a=null,l=Lv;for(const u of o){const d=Math.hypot(u.x-t,u.y-n);d<l&&(l=d,a=u)}if(!a)return null;const c=od(a,e,s,r);return{x:c.x,y:c.y,yaw:c.yaw,point:a}}function kv(i,e,t,n,s,r,o=.3){const a=Ov(i,e,t,n,s,r);if(a)return{x:a.x,y:a.y,yaw:a.yaw};const l=Je[e],c=l.length===l.width&&l.width===l.thickness;if(r||c)return{x:as(t),y:as(n),yaw:s};const u=td(e,t,n,0,s,r),d=(u.x1-u.x0)/2,h=(u.y1-u.y0)/2,f=i.query({x0:u.x0-1.5,x1:u.x1+1.5,y0:u.y0-1.5,y1:u.y1+1.5,z0:-50,z1:50}),m=[],_=[];for(const p of f){const y=Mn(p);m.push(y.x1+d,y.x0-d,y.x0+d,y.x1-d,(y.x0+y.x1)/2),_.push(y.y1+h,y.y0-h,y.y0+h,y.y1-h,(y.y0+y.y1)/2)}const g=(p,y)=>{let b=p,M=o;for(const T of y){const w=Math.abs(T-p);w<M&&(M=w,b=T)}return b===p?Math.round(p/Dh)*Dh:b};return{x:g(t,m),y:g(n,_),yaw:s}}const ta=i=>({job:null,leaderId:i,path:null,think:0}),Cn=1.6,ad=4.5,tl=new Map,Oh=.25,Bv=.3,zv=1.5;function Gv(i,e,t,n,s){const r=Math.hypot(n-e,s-t),o=Math.max(1,Math.ceil(r/.2));for(let a=1;a<=o;a++){const l=a/o;if(!i.canStand(e+(n-e)*l,t+(s-t)*l))return!1}return!0}function kh(i,e,t,n,s){const r=t-i.x,o=n-i.y,a=Math.hypot(r,o);if(a<=s||a===0)return e.canStand(t,n)&&(i.x=t,i.y=n),"arrived";i.facing=Math.atan2(o,r);const l=i.x+r/a*s,c=i.y+o/a*s,u=i.x,d=i.y;return e.canStand(l,c)?(i.x=l,i.y=c):e.canStand(l,i.y)?i.x=l:e.canStand(i.x,c)&&(i.y=c),Math.hypot(i.x-u,i.y-d)>s*.25?"moved":"stuck"}function yt(i,e,t,n,s){const r=e.speedMultiplier(Math.floor(i.x),Math.floor(i.y));if(r<=0)return!1;const o=Yu(i,r)*s,a=Ue(i.x,i.y,t,n),l=()=>Ue(i.x,i.y,t,n)<=o+1e-6;let c=tl.get(i.id);if((!c||Ue(c.goalX,c.goalY,t,n)>zv)&&(c={goalX:t,goalY:n,waypoints:[],cooldown:0,lastGoalDist:a,stall:0},tl.set(i.id,c)),c.goalX=t,c.goalY=n,c.cooldown-=s,c.waypoints.length>0){let h=0;for(let _=c.waypoints.length-1;_>0;_--)if(Gv(e,i.x,i.y,c.waypoints[_].x,c.waypoints[_].y)){h=_;break}h>0&&c.waypoints.splice(0,h);const f=c.waypoints[0];if(Ue(i.x,i.y,f.x,f.y)<=Bv)return c.waypoints.shift(),c.waypoints.length===0&&(c.stall=0,c.lastGoalDist=Ue(i.x,i.y,t,n)),l();kh(i,e,f.x,f.y,o);const m=Ue(i.x,i.y,t,n);return c.stall=c.lastGoalDist-m>o*.2?0:c.stall+s,c.lastGoalDist=m,c.stall>Oh&&c.cooldown<=0&&Bh(c,e,i,t,n),!1}if(kh(i,e,t,n,o)==="arrived")return c.stall=0,l();const d=Ue(i.x,i.y,t,n);return c.stall=c.lastGoalDist-d>o*.2?0:c.stall+s,c.lastGoalDist=d,c.stall>Oh&&c.cooldown<=0&&Bh(c,e,i,t,n),!1}function Bh(i,e,t,n,s){const r=Rv(e,t.x,t.y,n,s);i.waypoints=r??[],i.cooldown=r?.6:1,i.stall=0}function zh(i){tl.delete(i)}function ld(i,e){if(!e.canStand(i.x,i.y))for(let t=.3;t<=2.5;t+=.3)for(let n=0;n<12;n++){const s=n/12*Math.PI*2,r=i.x+Math.cos(s)*t,o=i.y+Math.sin(s)*t;if(e.canStand(r,o)){i.x=r,i.y=o;return}}}function Hv(i,e,t,n){if(!i.carrying)return!1;const s=Ue(i.x,i.y,t.x,t.y),r=.7;if(s<.45){let a=i.x-t.x,l=i.y-t.y;Math.hypot(a,l)<.001&&(a=1,l=0);const c=Math.hypot(a,l);return i.stance=xe.Moving,yt(i,e,t.x+a/c*r,t.y+l/c*r,n),!1}if(s>Cn)return i.stance=xe.Moving,yt(i,e,t.x,t.y,n),!1;i.stance=xe.Working,i.actionTimer=.3;const o=ls(e,e.pieces,i.carrying.kind,t.x,t.y,0,!0);return o.ok?(cs(e.pieces,i.carrying.kind,t.x,t.y,0,!0,o),i.carrying=null,ld(i,e),!0):!1}function Vv(i,e,t,n,s,r){if(!mt(i))return;if(ld(i,t),e.think-=r,i.stamina<8){i.stance=xe.Sleeping,i.stamina=Math.min(100,i.stamina+9*r);return}if(i.stance===xe.Sleeping){if(i.stamina=Math.min(100,i.stamina+9*r),i.stamina<65)return;i.stance=xe.Idle}if(i.order==="stopped"){i.stance=xe.Idle,i.stamina=Math.min(100,i.stamina+3.5*r);return}if(i.order==="chop"){Xv(i,t,n,r);return}if(i.order==="mine"){$v(i,t,n,r);return}if(i.order==="build"){qv(i,t,n,r);return}if(i.order==="haul"){Kv(i,t,n,r);return}if(i.order==="forage"){jv(i,t,n,r);return}if(!e.job&&e.think<=0&&(e.job=n.claim(i,t),e.think=.4),e.job){eM(i,e,e.job,t,n,s,r)&&(n.complete(e.job),e.job=null);return}const o=e.leaderId!==null?s.find(a=>a.id===e.leaderId):void 0;if(o&&Ue(i.x,i.y,o.x,o.y)>ad){i.stance=xe.Moving;const l=(i.id%5-2)*.9;yt(i,t,o.x+l,o.y+l*.6,r);return}i.stance=xe.Idle,i.stamina=Math.min(100,i.stamina+3.5*r)}const cd=45,hd=40,Wv=i=>i===Ye.OakTree||i===Ye.BirchTree||i===Ye.PineTree;function Bs(i,e){const t=i.pileOrDefault(e);return t?{x:t.x,y:t.y}:null}function kl(i,e,t,n){const s=i.carrying;if(!s)return!0;if(!t)return!1;if(Ue(i.x,i.y,t.x,t.y)>1.6)return i.stance=xe.Moving,yt(i,e,t.x,t.y,n),!1;const r=Ev(e,e.pieces,t,s.kind),o=ls(e,e.pieces,s.kind,r.x,r.y,r.yaw,r.upright,r.z);if(o.ok){const l=cs(e.pieces,s.kind,r.x,r.y,r.yaw,r.upright,o);return s.kind==="log"&&(l.loose=!0),i.carrying=null,!0}const a=ls(e,e.pieces,s.kind,i.x,i.y,s.yaw,s.upright);if(a.ok){const l=cs(e.pieces,s.kind,i.x,i.y,s.yaw,s.upright,a);return s.kind==="log"&&(l.loose=!0),i.carrying=null,!0}return!1}function Xv(i,e,t,n){const s=Bs(t,i.dropPile);if(i.carrying){kl(i,e,s,n);return}if(s){const l=Ol(e.pieces,s,i,3);if(l.length>0){const c=l[0];Ue(i.x,i.y,c.x,c.y)>1.6?(i.stance=xe.Moving,yt(i,e,c.x,c.y,n)):(i.carrying={kind:c.kind,yaw:c.yaw,upright:c.upright,lift:0},e.pieces.remove(c));return}}const r=e.resourcesNear(i.x,i.y,hd).filter(l=>Wv(l.kind));if(r.length===0){i.stance=xe.Idle,i.stamina=Math.min(100,i.stamina+3.5*n);return}const o=r[0];if(Ue(i.x,i.y,o.x,o.y)>Cn){i.stance=xe.Moving,yt(i,e,o.x,o.y,n);return}i.stance=xe.Working,i.actionTimer=.35,i.facing=Math.atan2(o.y-i.y,o.x-i.x),co(i,o,e,n).depleted&&Ul(o.kind)&&Fl(e,o.x,o.y,i.facing)}function $v(i,e,t,n){const s=Bs(t,i.dropPile);if(i.carrying){kl(i,e,s,n);return}if(s){const a=Ol(e.pieces,s,i,3);if(a.length>0){const l=a[0];Ue(i.x,i.y,l.x,l.y)>1.6?(i.stance=xe.Moving,yt(i,e,l.x,l.y,n)):(i.carrying={kind:l.kind,yaw:l.yaw,upright:l.upright,lift:0},e.pieces.remove(l));return}}const r=e.resourcesNear(i.x,i.y,hd).filter(a=>Mv(a.kind));if(r.length===0){i.stance=xe.Idle,i.stamina=Math.min(100,i.stamina+3.5*n);return}const o=r[0];if(Ue(i.x,i.y,o.x,o.y)>Cn){i.stance=xe.Moving,yt(i,e,o.x,o.y,n);return}i.stance=xe.Working,i.actionTimer=.35,i.facing=Math.atan2(o.y-i.y,o.x-i.x),i.stamina=Math.max(0,i.stamina-3.2*n),ju(e,o)}function qv(i,e,t,n){const s=wv(e.pieces,t.wallCells,i);if(!s){i.stance=xe.Idle,i.stamina=Math.min(100,i.stamina+3.5*n);return}if(i.carrying){Hv(i,e,s,n);return}const r=Bs(t,i.sourcePile),o=u=>u.kind==="log"&&!u.upright,a=[];r&&a.push(...e.pieces.queryRadius(r.x,r.y,Yv).filter(o)),a.push(...e.pieces.queryRadius(i.x,i.y,cd).filter(u=>o(u)&&u.loose));let l=null,c=1/0;for(const u of a){const d=(u.x-i.x)**2+(u.y-i.y)**2;d<c&&(c=d,l=u)}if(!l){i.stance=xe.Idle,i.stamina=Math.min(100,i.stamina+3.5*n);return}if(Ue(i.x,i.y,l.x,l.y)>Cn){i.stance=xe.Moving,yt(i,e,l.x,l.y,n);return}i.carrying={kind:l.kind,yaw:l.yaw,upright:l.upright,lift:0},e.pieces.remove(l)}const Yv=6;function Kv(i,e,t,n){const s=Bs(t,i.destPile);if(!s){i.stance=xe.Idle;return}const r=Bs(t,i.sourcePile)??s;if(i.carrying){kl(i,e,s,n);return}const o=Ol(e.pieces,s,r,cd);if(o.length===0){i.stance=xe.Idle,i.stamina=Math.min(100,i.stamina+3.5*n);return}let a=o[0],l=1/0;for(const c of o){const u=Ue(i.x,i.y,c.x,c.y);u<l&&(l=u,a=c)}if(l>1.6){i.stance=xe.Moving,yt(i,e,a.x,a.y,n);return}i.carrying={kind:a.kind,yaw:a.yaw,upright:a.upright,lift:0},e.pieces.remove(a)}const Zv=45,Jv=12,ud=i=>(pt[i].nutrition??0)>0;function Qv(i){let e=0;for(const[t,n]of i.inventory)ud(t)&&(e+=n);return e}function jv(i,e,t,n){const s=t.foodPile,r=Qv(i),o=e.resourcesNear(i.x,i.y,Zv).filter(l=>l.kind===Ye.BerryBush);if(s&&r>0&&(r>=Jv||o.length===0)){if(Ue(i.x,i.y,s.x,s.y)>1.6){i.stance=xe.Moving,yt(i,e,s.x,s.y,n);return}for(const[l,c]of[...i.inventory])ud(l)&&(Fs(i,l,c),e.dropItems(s.x,s.y,l,c));return}if(o.length===0){i.stance=xe.Idle,i.stamina=Math.min(100,i.stamina+3.5*n);return}const a=o[0];if(Ue(i.x,i.y,a.x,a.y)>Cn){i.stance=xe.Moving,yt(i,e,a.x,a.y,n);return}i.stance=xe.Working,i.actionTimer=.35,i.facing=Math.atan2(a.y-i.y,a.x-i.x),co(i,a,e,n)}function eM(i,e,t,n,s,r,o){switch(t.kind){case"harvest":{const a=t.nodeId!==void 0?n.findResource(t.nodeId,i.x,i.y):void 0;return a?$u(i)>=qu&&s.dropPoint?(i.stance=xe.Moving,yt(i,n,s.dropPoint.x,s.dropPoint.y,o)&&Gh(i,n,s),!1):Ue(i.x,i.y,a.x,a.y)>Cn?(i.stance=xe.Moving,yt(i,n,a.x,a.y,o),!1):(i.stance=xe.Working,i.actionTimer=.35,i.facing=Math.atan2(a.y-i.y,a.x-i.x),co(i,a,n,o).depleted?(Ul(a.kind)&&Fl(n,a.x,a.y,i.facing),!0):!1):!0}case"haulItems":return s.dropPoint?(i.stance=xe.Moving,yt(i,n,s.dropPoint.x,s.dropPoint.y,o)?(Gh(i,n,s),!0):!1):!0;case"haulPiece":{const a=t.pieceId!==void 0?n.pieces.get(t.pieceId):void 0;if(!a||t.tx===void 0||t.ty===void 0)return!0;if(!i.carrying)return Ue(i.x,i.y,a.x,a.y)>Cn?(i.stance=xe.Moving,yt(i,n,a.x,a.y,o),!1):(i.carrying={kind:a.kind,yaw:a.yaw,upright:a.upright,lift:0},n.pieces.remove(a),!1);if(i.stance=xe.Moving,yt(i,n,t.tx,t.ty,o)){const l=i.carrying,c=tM(n,t.tx,t.ty,l.kind,l.yaw,l.upright);return i.carrying=null,c?cs(n.pieces,l.kind,c.x,c.y,l.yaw,l.upright,c.result):n.pieces.add(xn(l.kind,i.x,i.y,n.elevationAt(i.x,i.y),l.yaw,l.upright)),!0}return!1}case"buildFixture":{const a=n.fixtures.find(u=>u.id===t.fixtureId);if(!a||a.progress>=1)return!0;const c=yn[a.kind].cost.find(u=>{var h;return(((h=a.delivered.find(f=>f.item===u.item))==null?void 0:h.count)??0)+Ai(i,u.item)<u.count});if(c&&s.dropPoint){const u=n.pileNear(s.dropPoint.x,s.dropPoint.y,2.5);if(u&&(u.contents.get(c.item)??0)>0){if(Ue(i.x,i.y,u.x,u.y)>Cn)return i.stance=xe.Moving,yt(i,n,u.x,u.y,o),!1;const d=Math.min(c.count,u.contents.get(c.item)??0);return u.contents.set(c.item,(u.contents.get(c.item)??0)-d),(u.contents.get(c.item)??0)<=0&&u.contents.delete(c.item),u.contents.size===0&&n.removePile(u),i.inventory.set(c.item,Ai(i,c.item)+d),!1}}return Ue(i.x,i.y,a.tx+.5,a.ty+.5)>Cn?(i.stance=xe.Moving,yt(i,n,a.tx+.5,a.ty+.5,o),!1):(i.stance=xe.Working,i.actionTimer=.3,yv(i,a,o))}case"attack":{const a=r.find(l=>l.id===t.actorId);return!a||!mt(a)?!0:(Zr(i,"fight"),Ue(i.x,i.y,a.x,a.y)>Cn?(i.stance=xe.Moving,yt(i,n,a.x,a.y,o),!1):(i.stance=xe.Fighting,!1))}case"guard":return t.tx===void 0||t.ty===void 0?!0:(Ue(i.x,i.y,t.tx,t.ty)>1.5?(i.stance=xe.Moving,yt(i,n,t.tx,t.ty,o)):i.stance=xe.Idle,!1);case"follow":{const a=r.find(l=>l.id===t.actorId);return a?(Ue(i.x,i.y,a.x,a.y)>ad&&(i.stance=xe.Moving,yt(i,n,a.x,a.y,o)),!1):!0}default:return!0}}function Gh(i,e,t){if(t.dropPoint)for(const[n,s]of[...i.inventory])pt[n].tool||(e.dropItems(t.dropPoint.x,t.dropPoint.y,n,s),i.inventory.delete(n))}function tM(i,e,t,n,s,r){for(let o=0;o<=4;o+=.5){const a=o===0?1:Math.max(6,Math.round(o*8));for(let l=0;l<a;l++){const c=l/a*Math.PI*2,u=e+Math.cos(c)*o,d=t+Math.sin(c)*o,h=ls(i,i.pieces,n,u,d,s,r);if(h.ok)return{x:u,y:d,result:h}}}return null}const nM=i=>i===Ye.OakTree||i===Ye.BirchTree||i===Ye.PineTree,zr=5;class iM{constructor(){G(this,"jobs",[]);G(this,"stockpiles",[]);G(this,"foodPile",null);G(this,"designated",new Set);G(this,"wallLines",[]);G(this,"nextWallLineId",1)}pileById(e){if(e!=null)return this.stockpiles.find(t=>t.id===e)}defaultPile(){let e;for(const t of this.stockpiles)(!e||t.id<e.id)&&(e=t);return e}pileOrDefault(e){return this.pileById(e)??this.defaultPile()}setPile(e,t,n){const s=this.pileById(e);if(s)return s.x=t,s.y=n,s;const r={id:e,x:t,y:n};return this.stockpiles.push(r),this.stockpiles.sort((o,a)=>o.id-a.id),r}freePileId(){for(let e=1;e<=zr;e++)if(!this.pileById(e))return e;return null}removePile(e){this.stockpiles=this.stockpiles.filter(t=>t.id!==e)}get dropPoint(){const e=this.defaultPile();return e?{x:e.x,y:e.y}:null}set dropPoint(e){var t;e&&this.setPile(((t=this.defaultPile())==null?void 0:t.id)??1,e.x,e.y)}get wallCells(){return this.wallLines.flatMap(e=>e.cells)}hasWallCell(e,t){return this.wallLines.some(n=>n.cells.some(s=>Math.abs(s.x-e)<1e-6&&Math.abs(s.y-t)<1e-6))}addWallLine(e){const t=e.filter(n=>!this.hasWallCell(n.x,n.y));t.length&&this.wallLines.push({id:this.nextWallLineId++,cells:t})}addWallCell(e,t){this.addWallLine([{x:e,y:t}])}clearWallPlan(){this.wallLines=[]}removeWallLineAt(e,t,n=.2){const s=n*n,r=this.wallLines.findIndex(a=>a.cells.some(l=>(l.x-e)**2+(l.y-t)**2<=s));if(r<0)return 0;const[o]=this.wallLines.splice(r,1);return o.cells.length}designate(e,t=1){nM(e.kind)||this.designated.has(e.id)||(this.designated.add(e.id),this.jobs.push({kind:"harvest",nodeId:e.id,tx:Math.floor(e.x),ty:Math.floor(e.y),priority:t}))}undesignate(e){this.designated.delete(e),this.jobs=this.jobs.filter(t=>t.nodeId!==e)}exportState(){return{stockpiles:this.stockpiles.map(e=>({...e})),foodPile:this.foodPile?{...this.foodPile}:null,wallLines:this.wallLines.map(e=>({id:e.id,cells:e.cells.map(t=>({...t}))})),nextWallLineId:this.nextWallLineId,designated:[...this.designated]}}importState(e){this.stockpiles=e.stockpiles.map(t=>({...t})),this.foodPile=e.foodPile?{...e.foodPile}:null,this.wallLines=e.wallLines.map(t=>({id:t.id,cells:t.cells.map(n=>({...n}))})),this.nextWallLineId=e.nextWallLineId,this.designated.clear();for(const t of e.designated)this.designated.add(t);this.jobs=[]}addFixtureJob(e,t=2){this.jobs.some(n=>n.fixtureId===e.id)||this.jobs.push({kind:"buildFixture",fixtureId:e.id,tx:e.tx,ty:e.ty,priority:t})}addHaulPiece(e,t,n,s=2){this.jobs.push({kind:"haulPiece",pieceId:e.id,tx:t,ty:n,priority:s})}claim(e,t){let n=null,s=-1/0;for(const r of this.jobs){if(r.claimedBy!==void 0||r.kind==="harvest"&&r.nodeId!==void 0&&!t.findResource(r.nodeId,e.x,e.y))continue;if(r.kind==="buildFixture"&&r.fixtureId!==void 0){const l=t.fixtures.find(c=>c.id===r.fixtureId);if(!l||l.progress>=1)continue}const o=Math.hypot((r.tx??e.x)-e.x,(r.ty??e.y)-e.y),a=r.priority*100-o;a>s&&(s=a,n=r)}return n&&(n.claimedBy=e.id),n}release(e){e.claimedBy=void 0}complete(e){e.nodeId!==void 0&&this.designated.delete(e.nodeId);const t=this.jobs.indexOf(e);t>=0&&this.jobs.splice(t,1)}releaseAllFor(e){for(const t of this.jobs)t.claimedBy===e&&(t.claimedBy=void 0)}get pending(){return this.jobs.length}}const sM=15,Hh=34,rM=52,oM=88,aM=1.6;function nl(i){return i.faction!=="wildlife"||!i.species?!1:Xn[i.species].temper==="predator"||i.provoked===!0}function lM(i,e,t){const n=Xn[i];return Kr(n.name,"wildlife",e,t,{species:i,hp:n.hp,maxHp:n.hp,speed:n.speed,meleeBonus:n.meleeBonus,morale:100,stance:xe.Idle,impulse:0,heading:0,targetId:null})}function Vh(i,e,t,n){let s=0;for(const r of i)r.faction==="wildlife"&&mt(r)&&s++;for(let r=0;r<10&&s<sM;r++){const o=Math.random()*Math.PI*2,a=Hh+Math.random()*(rM-Hh),l=t+Math.cos(o)*a,c=n+Math.sin(o)*a;if(!e.canStand(l,c))continue;const u=e.biomeAt(Math.floor(l),Math.floor(c)),d=X_.filter(_=>Xn[_].biomes.includes(u));if(!d.length)continue;let h=0;for(const _ of d)h+=Xn[_].weight;let f=Math.random()*h,m=d[0];for(const _ of d)if(f-=Xn[_].weight,f<=0){m=_;break}i.push(lM(m,l,c)),s++}}function cM(i,e,t){for(let n=i.length-1;n>=0;n--){const s=i[n];s.faction==="wildlife"&&mt(s)&&Ue(s.x,s.y,e,t)>oM&&i.splice(n,1)}}function na(i,e,t,n,s){const r=t*n,o=i.x+Math.cos(e)*r,a=i.y+Math.sin(e)*r;s.canStand(o,a)?(i.x=o,i.y=a,i.facing=e):(i.heading=Math.random()*Math.PI*2,i.impulse=.4)}function hM(i,e,t){for(const n of i){if(n.faction!=="wildlife"||!mt(n)||!n.species)continue;const s=Xn[n.species];let r=null,o=1/0;for(const a of i){if(a.faction!=="settlers"||!mt(a))continue;const l=Ue(n.x,n.y,a.x,a.y);l<o&&(o=l,r=a)}if(nl(n)&&r&&o<=s.senseRange){n.targetId=r.id,o<=aM?(n.stance=xe.Fighting,n.facing=Math.atan2(r.y-n.y,r.x-n.x)):(n.stance=xe.Moving,na(n,Math.atan2(r.y-n.y,r.x-n.x),s.speed*1.05,t,e));continue}if(r&&o<=s.senseRange){n.stance=xe.Fleeing,n.targetId=null;const a=Math.atan2(n.y-r.y,n.x-r.x),l=o<2.5?1.08:1;na(n,a,s.speed*l,t,e);continue}n.targetId=null,n.provoked=!1,n.impulse=(n.impulse??0)-t,(n.impulse??0)<=0&&(Math.random()<.55?(n.impulse=1.5+Math.random()*2.5,n.stance=xe.Idle):(n.impulse=1+Math.random()*2,n.heading=Math.random()*Math.PI*2,n.stance=xe.Moving)),n.stance===xe.Moving&&n.heading!=null&&na(n,n.heading,s.speed*.34,t,e)}}const Wh=1.7,uM=1.15,Lr=new Map,dd=(i,e)=>{if(i.faction===e.faction)return!1;const t=i.faction==="wildlife",n=e.faction==="wildlife";return t&&n?!1:t?nl(i):n?nl(e):!0};function dM(i,e,t){for(const n of i){const s=(Lr.get(n.id)??0)-e;Lr.set(n.id,Math.max(0,s))}for(const n of i){if(!mt(n)||n.stance!==xe.Fighting||(Lr.get(n.id)??0)>0)continue;let s;if(n.targetId!=null){const a=i.find(l=>l.id===n.targetId);a&&mt(a)&&Ue(n.x,n.y,a.x,a.y)<=Wh?s=a:(!a||!mt(a))&&(n.targetId=null)}if(s||(s=i.find(a=>mt(a)&&dd(n,a)&&Ue(n.x,n.y,a.x,a.y)<=Wh)),!s)continue;Lr.set(n.id,uM),n.actionTimer=.3,n.facing=Math.atan2(s.y-n.y,s.x-n.x);const r=.72+n.stamina/100*.24;if(Math.random()>r){t.push({x:s.x,y:s.y,text:"miss",kind:"miss"});continue}const o=j_(n)*(.8+Math.random()*.4);if(s.hp-=o,n.stamina=Math.max(0,n.stamina-4),t.push({x:s.x,y:s.y,text:`-${Math.round(o)}`,kind:"hit"}),s.faction==="wildlife"&&(s.provoked=!0),s.hp<=0){if(s.hp=0,s.stance=xe.Idle,s.faction==="wildlife"&&s.species){const a=Xn[s.species].loot;for(const c of a)Ll(n,c.item,c.count);const l=a.map(c=>`${c.count} ${c.item}`).join(", ");t.push({x:s.x,y:s.y,text:`${s.name}: ${l}`,kind:"death"})}else t.push({x:s.x,y:s.y,text:`${s.name} falls`,kind:"death"});n.targetId=null}else s.stance!==xe.Fighting&&s.faction!=="wildlife"&&(s.stance=s.morale<30?xe.Fleeing:xe.Fighting)}}const fM=7;function pM(i){for(const e of i){if(!mt(e)||e.stance===xe.Fleeing||e.stance===xe.Sleeping||e.isPlayer)continue;i.find(n=>mt(n)&&dd(e,n)&&Ue(e.x,e.y,n.x,n.y)<=fM)?e.stance=xe.Fighting:e.stance===xe.Fighting&&(e.stance=xe.Idle)}}const Ei=12;function fd(i){return i==="log"?"log":i==="stone"?"stoneBlock":null}function Gr(i,e,t){let n=Ai(e,t);const s=fd(t);if(s)for(const o of i.pieces.queryRadius(e.x,e.y,Ei))o.kind===s&&!o.upright&&n++;const r=Ei*Ei;for(const o of i.piles)(o.x-e.x)**2+(o.y-e.y)**2<=r&&(n+=o.contents.get(t)??0);return n}function pd(i,e,t,n){let s=n;const r=Math.min(s,Ai(e,t));r>0&&(Fs(e,t,r),s-=r);const o=fd(t);if(s>0&&o)for(const l of i.pieces.queryRadius(e.x,e.y,Ei)){if(s<=0)break;l.kind===o&&!l.upright&&(i.pieces.remove(l),s--)}const a=Ei*Ei;for(const l of i.piles){if(s<=0)break;if((l.x-e.x)**2+(l.y-e.y)**2>a)continue;const c=l.contents.get(t)??0;if(c<=0)continue;const u=Math.min(s,c);c-u<=0?l.contents.delete(t):l.contents.set(t,c-u),s-=u}}function il(i,e,t){const n=t.in.every(r=>Gr(i,e,r.item)>=r.count),s=t.station!==void 0&&i.nearestFixture(e.x,e.y,t.station,Ei)===void 0;return{ok:n&&!s,hasMaterials:n,needsStation:s}}function mM(i,e,t){if(!il(i,e,t).ok)return!1;for(const n of t.in)pd(i,e,n.item,n.count);return Ll(e,t.out.item,t.out.count),!0}const ui=900,gM=["Ael","Bed","Cyne","Deor","Ead","Fris","Garn","Hroth","Ing","Leof","Mael","Nor","Osric","Pen","Read","Sig","Tor","Wyn","Yric","Beorn"],xM=["ham","ton","wic","burh","ford","stead","leah","cot","dun","mere"],_M=["Aedred","Beorhtric","Cuthwine","Dunstan","Eanfrith","Frithuwald","Godgifu","Hereward","Ingeld","Leofwine","Mildthryth","Osgar","Raedwald","Sigeberht","Tostig","Wulfstan","Yffe","Aethelflaed","Beorhtwynn","Ceolwulf","Eadgyth","Hild","Osthryth","Wilfrid"];function Xh(i,e,t){const n=i.peekBiome(e,t);return n===Pe.Grassland||n===Pe.Meadow||n===Pe.Forest}function vM(i,e,t){const n=to(e,t,i.seed^24301),s=sn(n);if(s()>.62)return null;const r=Math.round(e*ui+di(s,.15,.85)*ui),o=Math.round(t*ui+di(s,.15,.85)*ui);if(!Xh(i,r,o)){const a=i.findLandNear(r,o,120);return!a||!Xh(i,a.x,a.y)?null:$h(s,a.x,a.y,e,t)}return $h(s,r,o,e,t)}function $h(i,e,t,n,s){const r=Ls(i,6,34),o=i(),a=o<.18?"hostile":o<.72?"wary":"friendly";return{id:`v${n},${s}`,x:e,y:t,name:oa(i,gM)+oa(i,xM),population:r,disposition:a,standing:a==="friendly"?25:a==="hostile"?-45:0,materialised:!1,wealth:Ls(i,20,220),warriors:Math.max(2,Math.floor(r*di(i,.18,.4)))}}function MM(i,e,t,n,s){const r=[],o=Math.floor((e-n)/ui),a=Math.floor((e+n)/ui),l=Math.floor((t-n)/ui),c=Math.floor((t+n)/ui);for(let u=l;u<=c;u++)for(let d=o;d<=a;d++){const h=`${d},${u}`;let f=s.get(h);f===void 0&&(f=vM(i,d,u),s.set(h,f)),f&&Math.hypot(f.x-e,f.y-t)<=n&&r.push(f)}return r}function yM(i,e){if(e.materialised)return[];e.materialised=!0;const t=sn(to(Math.round(e.x),Math.round(e.y),i.seed^48879)),n=[],s=Math.max(2,Math.round(e.population/4));for(let r=0;r<s;r++){const o=r/s*Math.PI*2+t()*.6,a=di(t,5,6+s*1.6),l=Math.round(e.x+Math.cos(o)*a),c=Math.round(e.y+Math.sin(o)*a);Ji(i.peekBiome(l,c))||SM(i,l,c,t)}if(i.canPlaceFixture("campfire",Math.round(e.x),Math.round(e.y))){const r=i.placeFixtureSite("campfire",Math.round(e.x),Math.round(e.y));r.progress=1,r.hp=r.maxHp}for(let r=0;r<e.population;r++){const o=t()*Math.PI*2,a=di(t,1,10),l=r<e.warriors,c=Kr(oa(t,_M),"natives",e.x+Math.cos(o)*a,e.y+Math.sin(o)*a,{maxHp:l?120:90,hp:l?120:90,speed:l?3.2:2.9});l?(c.inventory.set("spear",1),c.equipped="spear"):c.inventory.set("seax",1),n.push(c)}return n}function SM(i,e,t,n){const s=Ls(n,3,4),r=Ls(n,3,4),o=i.elevationAt(e,t),a=Je.log.thickness,l=Je.post.length,c=Math.max(3,Math.round(.65/a)),u=[[e-s/2,t-r/2],[e+s/2,t-r/2],[e-s/2,t+r/2],[e+s/2,t+r/2]];for(const[g,p]of u)i.pieces.add(xn("post",g,p,o,0,!0));const d=o+l;for(let g=0;g<c;g++){const p=o+g*a;i.pieces.add(xn("log",e,t-r/2,p,0,!1)),i.pieces.add(xn("log",e-s/2,t,p,Math.PI/2,!1)),i.pieces.add(xn("log",e+s/2,t,p,Math.PI/2,!1)),g>0&&i.pieces.add(xn("log",e,t+r/2,p,0,!1))}const h=Math.max(d,o+c*a);i.pieces.add(xn("beam",e,t,h,0,!1));const f=Je.thatchBundle,m=Math.ceil(s/f.length)+1,_=Math.ceil(r/f.width)+1;for(let g=0;g<_;g++)for(let p=0;p<m;p++)i.pieces.add(xn("thatchBundle",e-s/2+(p+.5)*f.length,t-r/2+(g+.5)*f.width,h+Je.beam.thickness,0,!1))}const ia={wary:"Wary",friendly:"Friendly",hostile:"Hostile"},qh=.8,bM=.5;function Qr(i,e,t,n){return{x0:i,x1:i+1,y0:e,y1:e+1,z0:t,z1:n}}function As(i,e,t){const n=i.elevationAt(e,t),s=i.pieces.query(Qr(e,t,n+.01,n+bM));if(s.length===0)return!1;let r=0;const o=Qr(e,t,-50,50);for(const a of s){const l=Mn(a),c=Math.min(l.x1,o.x1)-Math.max(l.x0,o.x0),u=Math.min(l.y1,o.y1)-Math.max(l.y0,o.y0);c>0&&u>0&&(r+=c*u)}return r>.4}function sl(i,e,t){const n=i.elevationAt(e,t),s=i.pieces.query(Qr(e,t,n+qh,n+qh+2.5));let r=0,o=!1;const a=Qr(e,t,-50,50);for(const h of s){const f=Mn(h),m=Math.min(f.x1,a.x1)-Math.max(f.x0,a.x0),_=Math.min(f.y1,a.y1)-Math.max(f.y0,a.y0);m>0&&_>0&&(r+=m*_,Je[h.kind].roofing&&(o=!0))}r=Math.min(1,r);let l=0;As(i,e+1,t)&&l++,As(i,e-1,t)&&l++,As(i,e,t+1)&&l++,As(i,e,t-1)&&l++;const c=r>.5,u=c&&l>=3;let d=r*.55+l/4*.35;return o&&(d+=.1),{roofed:c,cover:r,walls:l,enclosed:u,quality:Math.min(1,d),weathertight:o}}function EM(i,e,t,n=400){if(!sl(i,e,t).roofed)return{tiles:0,quality:0,enclosed:!1};const r=new Set,o=[[e,t]];let a=0,l=0,c=!1;for(;o.length&&a<n;){const[u,d]=o.shift(),h=`${u},${d}`;if(r.has(h))continue;r.add(h);const f=sl(i,u,d);if(!f.roofed){c=!0;continue}a++,l+=f.quality;for(const[m,_]of[[1,0],[-1,0],[0,1],[0,-1]])As(i,u+m,d+_)||o.push([u+m,d+_])}return{tiles:a,quality:a>0?l/a:0,enclosed:!c&&a>0}}const wM=["Wulfhere","Eadgar","Beorn","Hild","Cynric","Aelfwyn","Oswine","Godric","Leofa","Saewine","Merewald","Eanswith","Aethelred","Osric","Wynflaed","Beorhtric","Cuthbert","Eadgyth","Frithuwald","Hereric","Ceolwulf","Sigeberht","Aelfgifu","Deormund","Osgar","Wihtred","Leofric","Burghild","Egbert","Sunngifu","Aldhelm","Beornwulf","Coenred","Dunstan","Eadwig","Godgifu","Heahmund","Osthryth","Raedwald","Selwyn","Theodric","Wilfrun"],TM=10,AM=20260720,ri=ts*1.03,RM=150,Yh="scroll to zoom · drag to pan · click to copy",Kh={x:2435,y:10077},Bl=6,zs=450;function CM(i){const e=(Math.log(zs)-Math.log(i))/(Math.log(zs)-Math.log(Bl));return Math.round(Math.max(0,Math.min(1,e))*100)}function Zh(i){const e=Math.max(0,Math.min(1,i/100));return Math.exp(Math.log(zs)-e*(Math.log(zs)-Math.log(Bl)))}const Jh=[[26,54,88],[47,107,140],[206,189,142],[86,98,66],[110,138,72],[124,152,78],[74,104,56],[62,88,58],[116,106,74],[124,122,116],[226,230,236]],Ir="settlement.save",Qh=2,PM=i=>({...i,inventory:[...i.inventory]}),LM=i=>({...i,inventory:new Map(i.inventory)}),IM=24,sa=5,jh=5.5,eu=8,jr=Math.PI/12,DM=Math.PI/36,NM=Math.PI/2-.001,ra=i=>Math.max(DM,Math.min(NM,Cs+Math.round((i-Cs)/jr)*jr)),tu=Math.PI/2,UM=i=>Math.round(i/(Math.PI/2))*(Math.PI/2);function nu(i,e){const t=e.x-i.x,n=e.y-i.y,s=Math.max(1,Math.round(Math.hypot(t,n)/Ps)),r=[],o=new Set;for(let a=0;a<=s;a++){const l=as(i.x+t*a/s),c=as(i.y+n*a/s),u=`${l},${c}`;o.has(u)||(o.add(u),r.push({x:l,y:c}))}return r}class FM{constructor(e,t){G(this,"world");G(this,"renderer");G(this,"input");G(this,"hud");G(this,"board",new iM);G(this,"camera",{x:0,y:0,yaw:Jo,pitch:Cs,zoom:Zh(30)});G(this,"introZoomTarget",Zh(93));G(this,"cursor",{x:0,y:0,z:0});G(this,"hoveredNodeId",null);G(this,"hoveredPiece",null);G(this,"player");G(this,"actors",[]);G(this,"ai",new Map);G(this,"villageCache",new Map);G(this,"knownVillages",[]);G(this,"selection",{mode:"piece",kind:"log"});G(this,"carryLift",0);G(this,"combatEvents",[]);G(this,"floaters",[]);G(this,"time",9);G(this,"day",1);G(this,"lastFrame",performance.now());G(this,"activeNode",null);G(this,"rosterOpen",!1);G(this,"craftOpen",!1);G(this,"mapOpen",!1);G(this,"mapView",{cx:0,cy:0,span:ri});G(this,"mapRegion",null);G(this,"mapRegionKey","");G(this,"mapDrag",null);G(this,"lastGoodPlayer",{x:0,y:0});G(this,"playerDeathShown",!1);G(this,"hungerHintShown",!1);G(this,"wallMode",!1);G(this,"wallDragStart",null);G(this,"wallPreview",[]);G(this,"wasLeftDown",!1);G(this,"pileMode",!1);G(this,"activePileSlot",1);G(this,"targetYaw",Jo);G(this,"targetPitch",Cs);G(this,"snapPoints",[]);G(this,"snapBase",null);G(this,"activeSnap",null);G(this,"snapTurns",0);G(this,"frameDt",1/60);G(this,"shelterTimer",0);G(this,"needsTimer",0);G(this,"wildlifeTimer",0);G(this,"autosaveTimer",40);G(this,"cachedRoom",{tiles:0,quality:0,enclosed:!1});G(this,"started",!1);G(this,"frameErrors",0);const n=AM;this.world=new sf(n),this.renderer=new rv(e),this.input=new av(e),this.hud=new lv(t),this.hud.onSelect=h=>this.selection=h,this.hud.onSelectTool=h=>{(this.player.inventory.get(h)??0)>0&&(this.player.equipped=h)},this.hud.onOrder=(h,f)=>{const m=this.actors.find(_=>_.id===h);m&&this.setOrder(m,f)},this.hud.onOrderAll=h=>{const f=this.crew();for(const m of f)this.setOrder(m,h,!0);this.hud.log(`The whole crew is ${Ar[h]}.`)},this.hud.onLocate=h=>{const f=this.actors.find(m=>m.id===h);f&&(this.camera.x=f.x,this.camera.y=f.y,this.hud.log(`Looking at ${f.name}.`))},this.hud.onAssignPile=(h,f,m)=>{const _=this.actors.find(p=>p.id===h);if(!_)return;f==="drop"?_.dropPile=m:f==="source"?_.sourcePile=m:_.destPile=m;const g=f==="drop"?"stacks at":f==="source"?"takes from":"carries to";this.hud.log(`${_.name} ${g} pile ${m}.`)},this.hud.onPickPileSlot=h=>{this.activePileSlot=h},this.hud.onRemovePile=h=>{this.board.removePile(h),this.hud.log(`Pile ${h} removed.`)},this.hud.onCraft=h=>this.craftRecipe(h);const s=this.hud.mapCanvas,r=h=>{const f=s.getBoundingClientRect(),m=(h.clientX-f.left)/f.width,_=(h.clientY-f.top)/f.height;return{fx:m,fy:_,inside:m>=0&&m<=1&&_>=0&&_<=1}},o=(h,f)=>this.hud.setMapCoords(`x ${Math.round(h).toLocaleString()}   ·   y ${Math.round(f).toLocaleString()}`);s.addEventListener("mousemove",h=>{if(this.mapDrag)return;const{fx:f,fy:m}=r(h),_=this.mapFromCanvas(f,m);o(_.x,_.y)}),s.addEventListener("mouseleave",()=>{this.mapDrag||this.hud.setMapCoords(Yh)}),s.addEventListener("wheel",h=>{h.preventDefault();const{fx:f,fy:m}=r(h),_=this.mapFromCanvas(f,m);this.mapView.span*=h.deltaY>0?1.18:1/1.18,this.clampMapView(),this.mapView.cx=_.x-(2*f-1)*this.mapView.span,this.mapView.cy=_.y-(2*m-1)*this.mapView.span,this.clampMapView()},{passive:!1}),s.addEventListener("mousedown",h=>{this.mapDrag={sx:h.clientX,sy:h.clientY,moved:0,cx:this.mapView.cx,cy:this.mapView.cy}}),window.addEventListener("mousemove",h=>{const f=this.mapDrag;if(!f)return;const m=s.getBoundingClientRect(),_=h.clientX-f.sx,g=h.clientY-f.sy;f.moved=Math.max(f.moved,Math.hypot(_,g));const p=2*this.mapView.span/m.width;this.mapView.cx=f.cx-_*p,this.mapView.cy=f.cy-g*p,this.clampMapView()}),window.addEventListener("mouseup",h=>{var M;const f=this.mapDrag;if(!f||(this.mapDrag=null,f.moved>=5))return;const{fx:m,fy:_,inside:g}=r(h);if(!g)return;const p=this.mapFromCanvas(m,_),y=`${Math.round(p.x)}, ${Math.round(p.y)}`,b=()=>this.hud.setMapCoords(`✓ copied  ${y}`);try{const T=(M=navigator.clipboard)==null?void 0:M.writeText(y);T?T.then(b,()=>o(p.x,p.y)):o(p.x,p.y)}catch{o(p.x,p.y)}});const a=sn(n^4149),l=this.world.findSpawnNear(Kh.x,Kh.y);this.player=Kr("You","settlers",l.x,l.y,{isPlayer:!0,speed:3.6}),this.player.inventory.set("flintAxe",1),this.player.inventory.set("seax",1),this.player.inventory.set("berries",6),this.player.equipped="flintAxe",this.actors.push(this.player);const c=[...wM];for(let h=c.length-1;h>0;h--){const f=Math.floor(Math.random()*(h+1));[c[h],c[f]]=[c[f],c[h]]}for(let h=0;h<10;h++){const f=Kr(c[h%c.length],"settlers",l.x+(a()-.5)*8,l.y+(a()-.5)*8);f.inventory.set("berries",3),h<4&&f.inventory.set("flintAxe",1),(h===4||h===5)&&f.inventory.set("spear",1),this.actors.push(f),this.ai.set(f.id,ta(this.player.id))}this.lastGoodPlayer={x:l.x,y:l.y},this.board.setPile(1,l.x,l.y),this.board.foodPile={x:l.x+3,y:l.y+3},this.camera.x=l.x,this.camera.y=l.y,this.renderer.resize(),window.addEventListener("resize",()=>this.renderer.resize()),this.hud.log("You drag the boat above the tideline.");for(let h=0;h<3;h++)Vh(this.actors,this.world,l.x,l.y);const u=l.x+6,d=l.y+1;this.renderer.placeBoat(u,d,this.world.elevationAt(u,d),.5)}begin(){var e,t;this.started||(this.started=!0,(e=document.getElementById("mainMenu"))==null||e.remove(),(t=document.getElementById("hud"))==null||t.style.removeProperty("visibility"),requestAnimationFrame(()=>this.frame()))}get cursorWorld(){return this.cursor}floater(e,t,n,s="#e8e2d4"){this.floaters.push({x:e,y:t,text:n,life:1.4,colour:s})}updatePicking(){const e=this.renderer.pickGround(this.input.mouseX,this.input.mouseY,this.world);e&&(this.cursor=e);const t=Ue(this.player.x,this.player.y,this.cursor.x,this.cursor.y)>80,n=t?null:this.renderer.pickResource(this.cursor,this.world);this.hoveredNodeId=(n==null?void 0:n.id)??null,this.hoveredPiece=this.player.carrying||t?null:this.renderer.pickPiece(this.input.mouseX,this.input.mouseY,this.world,this.player),this.updateSnapTarget()}nearestLiftablePiece(e){const t=this.world.pieces.queryRadius(this.player.x,this.player.y,e);if(!t.length)return null;let n=null,s=1/0;for(const r of t){const o=id(this.world.pieces,r).length,l=Ue(this.player.x,this.player.y,r.x,r.y)+o*6;l<s&&(s=l,n=r)}return n}updateSnapTarget(){const e=this.player.carrying;if(!e){this.snapPoints=[],this.activeSnap=null;return}const t=this.renderer.pickPiece(this.input.mouseX,this.input.mouseY,this.world,this.cursor);this.snapPoints=rd(this.world.pieces,this.cursor.x,this.cursor.y,5).filter(r=>sd(r,e.upright)).filter(r=>r.kind!=="top"||(t==null?void 0:t.id)===r.host.id);let n=null,s=IM;for(const r of this.snapPoints){const o=this.renderer.worldToScreen(r.x,r.y,r.z);if(!o.visible)continue;const a=Math.hypot(o.x-this.input.mouseX,o.y-this.input.mouseY);a<s&&(s=a,n=r)}this.snapBase=n,this.activeSnap=n}plannedPlacement(){const e=this.player;if(!e.carrying)return null;let t,n,s,r;if(this.activeSnap){const a=od(this.activeSnap,e.carrying.kind,e.carrying.yaw,e.carrying.upright,this.snapTurns);t=a.x,n=a.y,s=a.yaw,r=this.activeSnap.kind==="bottom"?this.world.elevationAt(a.x,a.y):a.z}else{const a=kv(this.world.pieces,e.carrying.kind,this.cursor.x,this.cursor.y,e.carrying.yaw,e.carrying.upright);t=a.x,n=a.y,s=a.yaw,r=this.world.elevationAt(t,n)+this.carryLift}const o=ls(this.world,this.world.pieces,e.carrying.kind,t,n,s,e.carrying.upright,r);return{x:t,y:n,yaw:s,result:o}}get hoveredNode(){if(this.hoveredNodeId!=null)return this.world.findResource(this.hoveredNodeId,this.player.x,this.player.y)}update(e){this.updateTime(e),this.autosaveTimer-=e,this.autosaveTimer<=0&&(this.autosaveTimer=40,this.saveGame(!0)),this.updatePicking(),this.updatePlayer(e),this.updateCamera(e),this.updateVillages();for(const t of this.actors){if(t===this.player||!mt(t))continue;const n=this.ai.get(t.id);n&&Vv(t,n,this.world,this.board,this.actors,e)}hM(this.actors,this.world,e),this.wildlifeTimer-=e,this.wildlifeTimer<=0&&(this.wildlifeTimer=1.5,Vh(this.actors,this.world,this.player.x,this.player.y),cM(this.actors,this.player.x,this.player.y)),pM(this.actors),dM(this.actors,e,this.combatEvents);for(const t of this.combatEvents)this.floater(t.x,t.y,t.text,t.kind==="death"?"#e0bd52":t.kind==="miss"?"#8b8578":"#d4694a"),t.kind==="death"&&this.hud.log(t.text);if(this.combatEvents.length=0,this.updateNeeds(e),this.world.tickRegrow(e),!mt(this.player)&&!this.playerDeathShown){this.playerDeathShown=!0;const t=this.player.hunger<=0?"starved":this.player.warmth<18?"frozen":"fallen";this.hud.showBanner("You have "+t,"Your people carry on without you.",999999),this.hud.log("You have died.")}for(const t of this.actors)t.actionTimer>0&&(t.actionTimer-=e);for(const t of this.actors)mt(t)||(this.board.releaseAllFor(t.id),zh(t.id));this.actors=this.actors.filter(t=>mt(t)||t===this.player);for(const t of this.floaters)t.life-=e;this.floaters=this.floaters.filter(t=>t.life>0),this.world.evictFarChunks(Math.floor(this.camera.x),Math.floor(this.camera.y),this.renderer.viewChunksFor(this.camera)+2)}updateTime(e){this.time+=e/TM,this.time>=24&&(this.time-=24,this.day++,this.hud.log(`Day ${this.day} breaks.`))}updateNeeds(e){if(this.needsTimer+=e,this.needsTimer<.5)return;const t=this.needsTimer;this.needsTimer=0;const n=this.time<6||this.time>20;for(const s of this.actors){if(!mt(s))continue;if(s.hunger=Math.max(0,s.hunger-t*.22),s.hunger<35){let l=null,c=0;for(const u of s.inventory.keys()){const d=pt[u].nutrition??0;d>c&&(c=d,l=u)}if(l)Fs(s,l,1),s.hunger=Math.min(100,s.hunger+(pt[l].nutrition??0)),s.isPlayer&&this.floater(s.x,s.y,`ate ${pt[l].name.toLowerCase()}`,"#9ac36a");else{const u=this.world.takeFromLarder(this.board.foodPile);u&&(s.hunger=Math.min(100,s.hunger+(pt[u].nutrition??0)),s.isPlayer&&this.floater(s.x,s.y,`ate ${pt[u].name.toLowerCase()} from the larder`,"#9ac36a"))}}s.hunger<=0&&(s.stamina=Math.max(0,s.stamina-t*2),s.morale=Math.max(0,s.morale-t*2)),s.isPlayer&&s.hunger<30&&!this.hungerHintShown&&([...s.inventory.keys()].some(c=>(pt[c].nutrition??0)>0)||(this.hungerHintShown=!0,this.hud.log("Hungry. Left-click a berry bush to gather food — you eat it automatically.")));const r=sl(this.world,Math.floor(s.x),Math.floor(s.y)),o=this.world.nearestFixture(s.x,s.y,"campfire",6)!==void 0,a=n?r.quality>.4||o?62:22:72+r.quality*18;s.warmth+=(a-s.warmth)*t*.22,s.warmth<18&&(s.stamina=Math.max(0,s.stamina-t*1.5),s.morale=Math.max(0,s.morale-t*1.5)),s.stance===xe.Idle?s.stamina=Math.min(100,s.stamina+t*14):s.stance===xe.Moving&&(s.stamina=Math.min(100,s.stamina+t*5))}}updatePlayer(e){const t=this.player;if(!mt(t))return;Number.isFinite(t.x)&&Number.isFinite(t.y)?(this.lastGoodPlayer.x=t.x,this.lastGoodPlayer.y=t.y):(t.x=this.lastGoodPlayer.x,t.y=this.lastGoodPlayer.y);const n=this.input.moveVector();if(n.x!==0||n.y!==0){const s=Math.cos(this.camera.yaw),r=Math.sin(this.camera.yaw),o=-n.y*s-n.x*-r,a=-n.y*r-n.x*s,l=Math.hypot(o,a)||1,c=this.world.speedMultiplier(Math.floor(t.x),Math.floor(t.y)),u=this.input.isDown("shift")&&t.stamina>2,d=Yu(t,c)*(u?1.6:1),h=t.x+o/l*d*e,f=t.y+a/l*d*e;Number.isFinite(h)&&this.world.canStand(h,t.y)&&(t.x=h),Number.isFinite(f)&&this.world.canStand(t.x,f)&&(t.y=f),t.facing=Math.atan2(a,o),t.stance=xe.Moving,t.stamina=Math.max(0,t.stamina-e*(u?13:.5))}else t.stance===xe.Moving&&(t.stance=xe.Idle);this.handleHotkeys(),this.wallMode?this.updateWallTool():this.pileMode?this.updatePileTool():(this.handleCarry(e),this.handleClicks(e))}updatePileTool(){const e=this.input;for(let t=1;t<=zr;t++)e.pressed(String(t))&&(this.activePileSlot=t);if(e.leftClicked||e.rightClicked){const t=Math.round(this.cursor.x),n=Math.round(this.cursor.y),s=!this.board.pileById(this.activePileSlot),r=this.board.stockpiles.length;this.board.setPile(this.activePileSlot,t,n),this.hud.log(`Pile ${this.activePileSlot} placed.`),s&&r===1&&this.hud.log("Now open the roster (M) to choose which pile each worker uses.")}this.wasLeftDown=e.leftDown}updateWallTool(){const e=this.input,t={x:as(this.cursor.x),y:as(this.cursor.y)};if(e.leftClicked&&(this.wallDragStart=t),this.wallPreview=this.wallDragStart&&e.leftDown?nu(this.wallDragStart,t):[],this.wasLeftDown&&!e.leftDown&&this.wallDragStart){const n=nu(this.wallDragStart,t);this.board.addWallLine(n),this.wallDragStart=null,this.wallPreview=[],this.hud.log(`Wall outlined — ${this.board.wallCells.length} posts planned. Set a crew to build.`)}if(e.rightClicked&&!this.tryPickUp(!0)){const s=this.renderer.pickWallCell(e.mouseX,e.mouseY,this.wallGhostCells())??t,r=this.board.removeWallLineAt(s.x,s.y,Ps*.7);r&&this.hud.log(`Removed a wall line (${r} post${r>1?"s":""}).`)}this.wasLeftDown=e.leftDown}equipTool(e){const t=e.find(n=>(this.player.inventory.get(n)??0)>0);t&&(this.player.equipped=t)}handleHotkeys(){const e=this.input;if(this.pileMode||(Ku.forEach((t,n)=>{e.pressed(String(n+1))&&this.equipTool(t.options)}),ja.forEach((t,n)=>{e.pressed(String(n+5))&&(this.selection={mode:"fixture",kind:t})})),e.pressed("h")&&this.hud.toggleHelp(),e.pressed("m")&&(this.rosterOpen=!this.rosterOpen),e.pressed("n")&&(this.mapOpen=!this.mapOpen,this.hud.setMapVisible(this.mapOpen),this.mapOpen&&(this.mapView={cx:0,cy:0,span:ri},this.mapRegion=null,this.mapRegionKey="",this.hud.setMapCoords(Yh),this.drawMap())),e.pressed("k")&&(this.wallMode=!this.wallMode,this.wallDragStart=null,this.wallPreview=[],this.hud.log(this.wallMode?"Wall tool: left-drag to draw a line, right-click a line to delete it, K to finish.":"Wall tool off.")),e.pressed("p")&&(this.pileMode=!this.pileMode,this.pileMode&&this.wallMode&&(this.wallMode=!1),this.hud.log(this.pileMode?`Stockpile tool: press 1-${zr} to pick a pile, click the ground (either button) to place it. P to finish.`:"Stockpile tool off.")),e.pressed("g")&&(this.board.setPile(1,Math.floor(this.player.x),Math.floor(this.player.y)),this.hud.log("Pile 1 set. Haulers stack timber here by default.")),e.pressed("t")&&(this.board.foodPile={x:Math.floor(this.player.x),y:Math.floor(this.player.y)},this.hud.log("Larder set. Foragers will bring food here.")),e.pressed("c")&&(this.craftOpen=!this.craftOpen),e.pressed("o")&&this.saveGame(),e.pressed("l")&&this.loadGame(),this.player.carrying){const t=this.player.carrying,n=this.frameDt,s=this.snapBase!==null&&this.snapBase.kind!=="top";e.pressed("q")&&(s?this.snapTurns-=1:t.yaw-=Ih),e.pressed("e")&&(s?this.snapTurns+=1:t.yaw+=Ih),e.pressed("f")&&(t.upright=!t.upright,this.hud.log(t.upright?"Stood on end.":"Laid flat.")),e.isDown("v")&&(this.carryLift+=.5*n),e.isDown("b")&&(this.carryLift=Math.max(0,this.carryLift-.5*n))}e.wheelDelta!==0&&(this.introZoomTarget=null,this.camera.zoom=Math.max(Bl,Math.min(zs,this.camera.zoom*(1+e.wheelDelta*.0012)))),e.pressed("arrowleft")&&(this.targetYaw-=tu),e.pressed("arrowright")&&(this.targetYaw+=tu),e.pressed("arrowup")&&(this.targetPitch=ra(this.targetPitch+jr)),e.pressed("arrowdown")&&(this.targetPitch=ra(this.targetPitch-jr)),e.middleDown&&e.dragY!==0&&(this.targetPitch=ra(this.targetPitch+e.dragY*.004)),e.pressed("/")&&(this.targetYaw=Jo,this.targetPitch=Cs,this.hud.log("View reset."))}handleCarry(e){var s;if(!this.input.pressed("e"))return;const n=this.player;if(!n.carrying&&!this.tryPickUp(!1)&&((s=this.selection)==null?void 0:s.mode)==="piece"){const r=Je[this.selection.kind];r.fromItem&&Ai(n,r.fromItem)>0?(Fs(n,r.fromItem,1),n.carrying={kind:this.selection.kind,yaw:0,upright:!1,lift:0},this.carryLift=0):this.hud.log(`No ${r.fromItem?pt[r.fromItem].name.toLowerCase():"material"} to hand.`)}}tryPickUp(e){const t=this.player;if(t.carrying)return!1;const n=jh,s=this.world.resourcesNear(this.cursor.x,this.cursor.y,1.4).find(a=>a.kind===Ye.Boulder&&Ue(t.x,t.y,a.x,a.y)<n);if(s)return this.world.removeResource(s),t.carrying={kind:"boulder",yaw:0,upright:!1,lift:0},this.carryLift=0,this.hud.log("You heave the boulder up. Heavy going."),!0;const r=this.hoveredPiece&&Ue(t.x,t.y,this.hoveredPiece.x,this.hoveredPiece.y)<n?this.hoveredPiece:null,o=e?r:r??this.nearestLiftablePiece(n);if(o){const a=Nv(this.world,this.world.pieces,o);if(t.carrying={kind:o.kind,yaw:UM(o.yaw),upright:o.upright,lift:0},this.carryLift=0,a.collapsed.length){this.hud.log(`${a.collapsed.length} piece(s) came down with it.`);for(const l of a.collapsed){const c=Je[l.kind].fromItem;c&&this.world.dropItems(l.x,l.y,c,1)}}return!0}return!1}handleClicks(e){var r,o;const t=this.input,n=this.player,s=this.cursorWorld;if(n.carrying)t.leftClicked&&this.tryPlaceCarried();else if(((r=this.selection)==null?void 0:r.mode)==="fixture"&&t.leftClicked)this.tryPlaceFixture(this.selection.kind,Math.floor(s.x),Math.floor(s.y));else if(t.leftClicked&&((o=this.hoveredNode)==null?void 0:o.kind)===Ye.Boulder&&Ue(n.x,n.y,this.hoveredNode.x,this.hoveredNode.y)<sa){const a=this.hoveredNode;ju(this.world,a),n.stance=xe.Working,n.actionTimer=.3,n.facing=Math.atan2(a.y-n.y,a.x-n.x),this.hud.log("You knock the boulder square. A tidy block."),this.floater(a.x,a.y,"dressed","#c8c8c2")}else if(t.leftDown){const a=this.hoveredNode;if(a&&Ue(n.x,n.y,a.x,a.y)<sa){this.activeNode=a,n.stance=xe.Working,n.actionTimer=.3,n.facing=Math.atan2(a.y-n.y,a.x-n.x);const l=co(n,a,this.world,e);l.gained>0&&l.item&&this.floater(a.x,a.y,`+${l.gained} ${pt[l.item].name}`),l.depleted&&(Ul(a.kind)?(Fl(this.world,a.x,a.y,n.facing),this.hud.log(`${po[a.kind]} felled. The trunk lies where it fell.`),this.floater(a.x,a.y,"timber!","#e0bd52")):this.hud.log(`${po[a.kind]} exhausted.`),this.activeNode=null)}else{const l=this.actors.find(c=>c.faction!=="settlers"&&mt(c)&&Ue(c.x,c.y,s.x,s.y)<1.4);l&&Ue(n.x,n.y,l.x,l.y)<2.2&&(Zr(n,"fight"),n.stance=xe.Fighting,n.targetId=l.id)}}else this.activeNode&&(this.activeNode=null,n.stance===xe.Working&&(n.stance=xe.Idle));if(t.rightClicked&&!this.tryPickUp(!0)){const a=this.settlerUnderCursor();a?this.cycleOrder(a):this.setDeliveryPoint(Math.round(s.x),Math.round(s.y))}}settlerUnderCursor(){let e=null,t=42;for(const n of this.actors){if(n===this.player||n.faction!=="settlers"||!mt(n))continue;const s=this.renderer.worldToScreen(n.x,n.y,this.world.elevationAt(n.x,n.y)+.45);if(!s.visible)continue;const r=Math.hypot(s.x-this.input.mouseX,s.y-this.input.mouseY);r<t&&(t=r,e=n)}return e}cycleOrder(e){const t={follow:"chop",chop:"mine",mine:"build",build:"haul",haul:"forage",forage:"stopped",stopped:"follow"};this.setOrder(e,t[e.order])}setOrder(e,t,n=!1){if(e.order=t,e.order==="stopped"&&e.carrying){const s=ls(this.world,this.world.pieces,e.carrying.kind,e.x,e.y,e.carrying.yaw,e.carrying.upright);s.ok&&cs(this.world.pieces,e.carrying.kind,e.x,e.y,e.carrying.yaw,e.carrying.upright,s),e.carrying=null}n||this.hud.log(`${e.name} is ${Ar[e.order]}.`),(e.order==="haul"||e.order==="chop"||e.order==="mine")&&!this.board.dropPoint&&this.hud.log("Right-click open ground to set where they should stack it.")}crew(){return this.actors.filter(e=>e.faction==="settlers"&&!e.isPlayer&&mt(e))}mapFromCanvas(e,t){const{cx:n,cy:s,span:r}=this.mapView;return{x:n+(2*e-1)*r,y:s+(2*t-1)*r}}clampMapView(){this.mapView.span=Math.max(RM,Math.min(ri,this.mapView.span)),this.mapView.cx=Math.max(-ri,Math.min(ri,this.mapView.cx)),this.mapView.cy=Math.max(-ri,Math.min(ri,this.mapView.cy))}buildMapRegion(){const t=document.createElement("canvas");t.width=320,t.height=320;const n=t.getContext("2d"),s=n.createImageData(320,320),{cx:r,cy:o,span:a}=this.mapView;for(let l=0;l<320;l++){const c=o-a+(l+.5)/320*2*a;for(let u=0;u<320;u++){const d=r-a+(u+.5)/320*2*a,h=this.world.peekBiome(Math.round(d),Math.round(c)),f=Jh[h]??Jh[Pe.Ocean],m=(l*320+u)*4;s.data[m]=f[0],s.data[m+1]=f[1],s.data[m+2]=f[2],s.data[m+3]=255}}return n.putImageData(s,0,0),t}drawMap(){const{cx:e,cy:t,span:n}=this.mapView,s=`${Math.round(e)},${Math.round(t)},${Math.round(n)}`;(!this.mapRegion||s!==this.mapRegionKey)&&(this.mapRegion=this.buildMapRegion(),this.mapRegionKey=s);const r=this.hud.mapCanvas,o=r.getContext("2d");if(!o)return;const a=r.width,l=r.height,c=(f,m)=>({x:(f-(e-n))/(2*n)*a,y:(m-(t-n))/(2*n)*l});o.imageSmoothingEnabled=n>ri*.35,o.clearRect(0,0,a,l),o.drawImage(this.mapRegion,0,0,a,l);const u=(f,m,_,g,p="#0d1620")=>{const y=c(f,m);o.beginPath(),o.arc(y.x,y.y,_,0,Math.PI*2),o.fillStyle=g,o.fill(),o.lineWidth=1.5,o.strokeStyle=p,o.stroke()};for(const f of this.knownVillages){const m=f.disposition==="friendly"?"#7fbf4f":f.disposition==="hostile"?"#c0503f":"#d9a441";u(f.x,f.y,4,m)}const d=this.board.pileById(1);d&&u(d.x,d.y,4.5,"#e0bd52");const h=c(this.player.x,this.player.y);o.beginPath(),o.arc(h.x,h.y,9,0,Math.PI*2),o.fillStyle="rgba(223,227,234,0.25)",o.fill(),u(this.player.x,this.player.y,4.5,"#dfe3ea"),o.fillStyle="rgba(244,236,216,0.8)",o.font="600 14px system-ui, sans-serif",o.textAlign="center",o.fillText("N",a/2,16)}hasSave(){try{return localStorage.getItem(Ir)!==null}catch{return!1}}deleteSave(){try{localStorage.removeItem(Ir)}catch{}}saveGame(e=!1){const t={version:Qh,seed:this.world.seed,day:this.day,time:this.time,camera:{...this.camera,targetYaw:this.targetYaw,targetPitch:this.targetPitch},world:this.world.exportState(),board:this.board.exportState(),actors:this.actors.map(PM),playerId:this.player.id,actorId:Y_(),villages:this.knownVillages,flags:{playerDeathShown:this.playerDeathShown,hungerHintShown:this.hungerHintShown}};try{localStorage.setItem(Ir,JSON.stringify(t)),this.hud.log(e?"Autosaved.":`Game saved — day ${this.day}, ${String(Math.floor(this.time)).padStart(2,"0")}:00.`)}catch(n){this.hud.log("Could not save the game."),console.error("[save]",n)}}loadGame(){let e;try{e=localStorage.getItem(Ir)}catch{e=null}if(!e){this.hud.log("No saved game to load.");return}let t;try{t=JSON.parse(e)}catch{this.hud.log("The saved game is corrupt.");return}if(t.version!==Qh||t.seed!==this.world.seed){this.hud.log("That save is from a different version and cannot be loaded.");return}this.world.importState(t.world),this.board.importState(t.board),this.actors=t.actors.map(LM),this.player=this.actors.find(n=>n.id===t.playerId)??this.actors[0],this.ai.clear();for(const n of this.actors)zh(n.id),n.isPlayer||this.ai.set(n.id,ta(this.player.id));K_(t.actorId),this.day=t.day,this.time=t.time,this.camera.x=t.camera.x,this.camera.y=t.camera.y,this.camera.yaw=t.camera.yaw,this.camera.pitch=t.camera.pitch,this.camera.zoom=t.camera.zoom,this.targetYaw=t.camera.targetYaw,this.targetPitch=t.camera.targetPitch,this.knownVillages=t.villages??[],this.villageCache.clear(),this.playerDeathShown=t.flags.playerDeathShown,this.hungerHintShown=t.flags.hungerHintShown,this.lastGoodPlayer={x:this.player.x,y:this.player.y},this.activeNode=null,this.hoveredPiece=null,this.hoveredNodeId=null,this.wallDragStart=null,this.wallPreview=[],this.hud.log(`Game loaded — day ${this.day}, ${String(Math.floor(this.time)).padStart(2,"0")}:00.`)}wallGhostCells(){const e=[...this.board.wallCells,...this.wallPreview],t=[],n=new Set;for(const s of e){const r=`${s.x},${s.y}`;n.has(r)||(n.add(r),!ed(this.world.pieces,s)&&t.push({x:s.x,y:s.y,z:this.world.elevationAt(s.x,s.y)}))}return t}setDeliveryPoint(e,t){this.board.dropPoint={x:e,y:t};const n=this.actors.filter(s=>s.order==="haul").length;this.hud.log(n>0?`Timber will be stacked here. ${n} hauling.`:"Timber will be stacked here. Right-click a settler to set them hauling.")}tryPlaceCarried(){const e=this.player;if(!e.carrying)return;const t=this.plannedPlacement();if(t){if(!t.result.ok){this.hud.log(t.result.reason??"It will not sit there.");return}if(Ue(e.x,e.y,t.x,t.y)>eu){this.hud.log("Too far to reach.");return}cs(this.world.pieces,e.carrying.kind,t.x,t.y,t.yaw,e.carrying.upright,t.result),e.carrying=null,this.carryLift=0,this.activeSnap=null,this.snapBase=null,this.snapTurns=0,e.stamina=Math.max(0,e.stamina-1.5)}}tryPlaceFixture(e,t,n){const s=yn[e];if(!this.world.canPlaceFixture(e,t,n)){this.hud.log("The ground will not take it.");return}const r=s.cost.filter(a=>Gr(this.world,this.player,a.item)<a.count);if(r.length){this.hud.log(`Need ${r.map(a=>`${a.count} ${pt[a.item].name.toLowerCase()}`).join(", ")} — stand near your stores.`);return}for(const a of s.cost)pd(this.world,this.player,a.item,a.count);const o=this.world.placeFixtureSite(e,t,n);o.progress=1,o.hp=o.maxHp,this.hud.log(`${s.name} raised.`)}craftRecipe(e){const t=Os.find(s=>s.id===e);if(!t)return;const n=il(this.world,this.player,t);if(n.needsStation&&t.station){this.hud.log(`Need a ${yn[t.station].name.toLowerCase()} nearby.`);return}if(!n.hasMaterials){this.hud.log("Not enough materials to hand.");return}mM(this.world,this.player,t)&&this.hud.log(`Crafted ${t.out.count} ${pt[t.out.item].name.toLowerCase()}.`)}updateCrafting(){if(!this.craftOpen){this.hud.setCrafting(!1,[]);return}const e=Os.map(t=>{const n=il(this.world,this.player,t);return{id:t.id,inputs:t.in.map(s=>({item:s.item,have:Gr(this.world,this.player,s.item),need:s.count})),stationNear:t.station?!n.needsStation:void 0,craftable:n.ok}});this.hud.setCrafting(!0,e)}updateCamera(e){this.camera.x+=(this.player.x-this.camera.x)*Math.min(1,e*6),this.camera.y+=(this.player.y-this.camera.y)*Math.min(1,e*6),this.camera.yaw+=(this.targetYaw-this.camera.yaw)*Math.min(1,e*9),this.camera.pitch+=(this.targetPitch-this.camera.pitch)*Math.min(1,e*9),this.introZoomTarget!==null&&(this.camera.zoom+=(this.introZoomTarget-this.camera.zoom)*Math.min(1,e*1.1),Math.abs(this.camera.zoom-this.introZoomTarget)<.15&&(this.camera.zoom=this.introZoomTarget,this.introZoomTarget=null))}updateVillages(){const e=MM(this.world,this.player.x,this.player.y,260,this.villageCache);for(const t of e){if(t.materialised||Ue(this.player.x,this.player.y,t.x,t.y)>90)continue;const n=yM(this.world,t);for(const s of n)this.actors.push(s),this.ai.set(s.id,ta(null));this.knownVillages.push(t),this.hud.showBanner(t.name,`${ia[t.disposition]} · ${t.population} souls`,4200),this.hud.log(`You come upon ${t.name}. They look ${ia[t.disposition].toLowerCase()}.`)}}draw(e){var l;const t=this.cursorWorld,n=this.player,s=this.plannedPlacement(),r=s?{kind:n.carrying.kind,x:s.x,y:s.y,z:s.result.z,yaw:s.yaw,upright:n.carrying.upright,ok:s.result.ok&&Ue(n.x,n.y,s.x,s.y)<=eu}:void 0;this.renderer.render(this.world,this.camera,this.actors,{ghost:r,snapPoints:n.carrying?this.snapPoints:void 0,activeSnap:this.activeSnap,stockpiles:this.board.stockpiles,activePileId:this.pileMode?this.activePileSlot:null,foodPile:this.board.foodPile,wallCells:this.wallGhostCells(),hoveredPiece:this.hoveredPiece,hoveredResourceId:this.hoveredNodeId,timeOfDay:this.time/24,dt:e}),this.drawFloaters(),this.drawPileLabels(),this.updateCrafting(),this.mapOpen&&this.drawMap(),this.hud.setPileTool(this.pileMode,this.activePileSlot,this.board.stockpiles.map(c=>c.id),zr),this.updateTooltip(t,this.hoveredPiece),this.shelterTimer-=e,this.shelterTimer<=0&&(this.shelterTimer=.5,this.cachedRoom=EM(this.world,Math.floor(n.x),Math.floor(n.y)));const o=this.cachedRoom,a=this.knownVillages.map(c=>({name:c.name,distance:Ue(n.x,n.y,c.x,c.y),disposition:ia[c.disposition]})).sort((c,u)=>c.distance-u.distance)[0];this.hud.setRoster(this.rosterOpen,this.crew().map(c=>({id:c.id,name:c.name,order:c.order,status:c.carrying?`carrying a ${Je[c.carrying.kind].name.toLowerCase()}`:Ar[c.order],distance:Ue(n.x,n.y,c.x,c.y),dropPile:c.dropPile,sourcePile:c.sourcePile,destPile:c.destPile})),this.board.stockpiles.map(c=>c.id),((l=this.board.defaultPile())==null?void 0:l.id)??null),this.hud.update(n,{day:this.day,hour:this.time,settlers:this.actors.filter(c=>c.faction==="settlers"&&mt(c)).length,hauling:this.actors.filter(c=>(c.order==="haul"||c.order==="chop"||c.order==="mine")&&mt(c)).length,pending:this.board.pending,pieces:this.world.pieces.count,larder:this.world.larderCount(this.board.foodPile),zoom:CM(this.camera.zoom),buildableFixtures:Object.fromEntries(ja.map(c=>[c,yn[c].cost.every(u=>Gr(this.world,this.player,u.item)>=u.count)])),selection:this.selection,nearestVillage:a,shelter:o.tiles>0?`${o.enclosed?"enclosed":"partial"}, ${o.tiles} tiles`:void 0},e)}drawPileLabels(){const e=this.crew();this.hud.setPileLabels(this.board.stockpiles.map(t=>{var c;const n=this.renderer.worldToScreen(t.x,t.y,this.world.elevationAt(t.x,t.y)+1.4),s=(c=this.board.defaultPile())==null?void 0:c.id,r=e.filter(u=>(u.order==="chop"||u.order==="mine")&&(u.dropPile??s)===t.id||u.order==="haul"&&(u.destPile??s)===t.id).length,o=e.filter(u=>(u.order==="haul"||u.order==="build")&&(u.sourcePile??s)===t.id).length,a=[];r&&a.push(`${r} in`),o&&a.push(`${o} out`);const l=a.length?`<span class="role">${a.join(" · ")}</span>`:"";return{x:n.x,y:n.y,text:`Pile ${t.id}${l}`,highlight:this.pileMode&&t.id===this.activePileSlot,visible:n.visible}}))}drawFloaters(){this.hud.setFloaters(this.floaters.map(e=>{const t=this.renderer.worldToScreen(e.x,e.y,this.world.elevationAt(e.x,e.y)+2);return{x:t.x,y:t.y-(1.4-e.life)*26,text:e.text,colour:e.colour,alpha:Math.min(1,e.life),visible:t.visible}}))}updateTooltip(e,t){const n=this.player;if(n.carrying){const a=Je[n.carrying.kind];let l="left click to set down · Q/E turn 90° · F upright · V/B raise";if(this.activeSnap){const c=this.activeSnap.host,d=Math.abs(Math.cos(n.carrying.yaw-c.yaw)*Math.cos((c.upright,0)))<.5,h=this.activeSnap.kind==="top"?`on top, ${d?"across":"along"} the ${Je[c.kind].name.toLowerCase()}`:this.activeSnap.kind==="bottom"?"at the foot, flat on the ground":`out from the ${Je[c.kind].name.toLowerCase()}`,f=this.activeSnap.kind==="top"?"turn 90°":"out / alongside";l=`${h} · Q/E ${f} · left click to set`}this.hud.setTip(`Carrying ${a.name}`,l,this.input.mouseX,this.input.mouseY);return}if(t&&Ue(n.x,n.y,t.x,t.y)<jh){const a=Je[t.kind];this.hud.setTip(a.name,`bearing ${Math.round(t.load)}/${a.bearing} · right click to lift`,this.input.mouseX,this.input.mouseY);return}const s=this.hoveredNode;if(s){const a=Ue(n.x,n.y,s.x,s.y)<sa;this.hud.setTip(`${po[s.kind]} (${Math.ceil(s.amount)})`,a?"hold left click to work":"too far to reach",this.input.mouseX,this.input.mouseY);return}const r=this.settlerUnderCursor();if(r){const a=r.carrying?` · carrying a ${Je[r.carrying.kind].name.toLowerCase()}`:"";this.hud.setTip(`${r.name} · ${Ar[r.order]}${a}`,"right click to change their orders",this.input.mouseX,this.input.mouseY);return}const o=this.actors.find(a=>a!==n&&mt(a)&&Ue(a.x,a.y,this.cursor.x,this.cursor.y)<1);if(o){const a=o.faction==="natives"?"islander":o.faction==="wildlife"?"wild beast":"settler",l=o.faction==="wildlife"?`${Math.round(o.hp)}/${o.maxHp} · hold left click to hunt`:`${Math.round(o.hp)}/${o.maxHp} health`;this.hud.setTip(`${o.name} · ${a}`,l,this.input.mouseX,this.input.mouseY);return}if(!n.carrying){this.hud.setTip("Ground","right click to set where timber is stacked",this.input.mouseX,this.input.mouseY);return}this.hud.setTip(null,null,0,0)}frame(){const e=performance.now(),t=Math.min(.05,(e-this.lastFrame)/1e3);this.lastFrame=e,this.frameDt=t;try{this.update(t),this.draw(t)}catch(n){this.reportFrameError(n)}this.input.endFrame(),requestAnimationFrame(()=>this.frame())}reportFrameError(e){if(this.frameErrors++,console.error("[frame error]",e),this.frameErrors<=3){const t=e instanceof Error?e.message:String(e);this.hud.log(`Something glitched: ${t}`)}}}const OM=document.getElementById("game"),md=document.getElementById("hud"),Ki=new FM(OM,md);window.game=Ki;mv();md.style.visibility="hidden";_v({hasSave:Ki.hasSave(),onBegin:()=>Ki.begin(),onContinue:()=>{Ki.loadGame(),Ki.begin()},onDeleteSave:()=>Ki.deleteSave()});
